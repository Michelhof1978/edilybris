...
<div class="text-center m-3">
    <img src="images/livresEtagere2.png" loading="lazy" alt="" class="img-fluid w-25">
</div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                ...
                <div class="row mb-4">
                    ...
                    <!-- Bouton d'envoi -->
                    <button type="submit" value="Valider" id="send-data" class="btn2 borderColorForm text-white fs-5 p-2 mb-4 rounded">
                        Envoyez
                    </button>
                </div>
            </div>
