        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/JocelynMailly/des-os-et-des-ailes-pourweb-1.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre Des os et des ailes">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Référence :</strong> 9782363440327
                    </p>
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/JocelynMailly/des-os-et-des-ailes-pourweb-1.webp" class="img-fluid" alt="Couverture du livre Des os et des ailes">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong>  9782363440327</p>

                        <p class="lead">
                        <strong class="h2Jaune">Résumé :</strong> S'inspirant des magnifiques paysages des Appalaches, cette chaine de montagnes du Sud des États-Unis, au cœur du Tennessee et de l'Alabama, l'auteur, dont l'imaginaire se nourrit des us et coutumes locales, nous entraîne dans un passé marqué par le fer de l'histoire.
...
<h3 class="h2Jaune text-center m-3">Présentation succincte du deuxième roman de Jocelyn Maily</h3>
<h4 class="h2Jaune text-center m-3">RÉSUMÉ</h4>
