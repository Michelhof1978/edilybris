        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/pierreBrandao/luciolesMagiques.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">10,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Luciole magique</h3>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2003
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 28
                    </p>
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Poésie illustrées
                    </p>
                    <p class="lead">
                        <strong class="h2Jaune">Résumé :</strong> LUCIOLES MAGIQUES est le deuxième fruit d'une rencontre avec Marie, rencontrée sur un des innombrables fils du net. De la passion des mots et des images ce recueil emporte le lecteur dans les sentiments troubles de la vie ; plutôt d'écriture libre, les thèmes évoqués ne pourront pas laisser indifférent. 
...
Recueil au format 21x29,7, totalement en couleurs, 26 pages de rêves poétiques. 
                    ...
                    <p>
<p><strong>Je nourris une larme…</strong></p><strong>Je nourris une larme…</strong>
<img src="images/pierreBrandao/jeNourrisUneLarme.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
...
<h3 class="h2Jaune text-center m-3">EXTRAIT DU RECUEIL</h3>
                    <p>
<strong>Miroir de mes saisons </strong>
<img src="images/pierreBrandao/miroirDeMesSaisons.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/pierreBrandao/luciolesMagiques.webp" class="img-fluid" alt="Couverture du livre L'enlèvement">
                        <p class="fw-bold coloryellow mt-3 fs-4 lead">10,00 €</p>
                    </div>
                    <div class="livre-details">
                        <h3 class="h2Jaune">Lucioles magiques</h3>
                        <p class="annee text-white"><strong class="h2Jaune">Année de publication :</strong> 2003</p>
                        <p class="annee text-white"><strong class="h2Jaune">Genre :</strong> Poésie illusttrées</p>
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 28</p>
...
Recueil au format 21x29,7, totalement en couleurs, 26 pages de rêves poétiques. 
                        ...
                        <p>
                        <p class="m-4"><strong>Je nourris une larme</strong></p>
...
<h3 class="h2Jaune text-center m-3">EXTRAIT DU RECUEIL</h3>
                    <p>
<p class="m-3 h2Jaune "><strong>Miroir de mes saisons </strong></p>
<img src="images/pierreBrandao/miroirDeMesSaisons.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
