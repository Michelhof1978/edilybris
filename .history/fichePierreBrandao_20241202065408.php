...
<main>
    ...
    <section class="livres">
        <div class="containerAuteur">
            ...
            <!-- Livre 2 -->
            <div class="livre">
                <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Couverture du livre Les Ombres du Passé">
                <div class="details">
            ...
            <!-- Livre 3 -->
            <div class="livre">
                <img src="images/pierreBrandao/XLlamourafleurdame.png" class="img-fluid" alt="Couverture du livre Les Mots de l'Amour">
                <div class="details">
            ...
            <!-- Livre 4 -->
            <div class="livre">
                <img src="images/pierreBrandao/XLlamuserie.png" class="img-fluid" alt="Couverture du livre Le Dernier Chapitre">
                <div class="details">
...
L’auteur plagierait bien volontiers Michel Sardou en fredonnant que tout est prétexte à chanson : cet ouvrage l’illustre parfaitement ! Alors, si un air vous trotte dans la tête en lisant, ne vous étonnez pas : c’est voulu !</p>
    ...
    <section class="citations text-white py-4">
        <div class="container">
            ...
            <!-- Première ligne de blockquote -->
            <div class="row">
                <div class="col-md-6">
            <h3 class="h2Jaune">BELLE</h3>
            <blockquote>
                <p>Plus belle qu'une aurore,<br>
...
Fleur du plus beau rêve...<br></p>
</blockquote>
                </div>
                <div class="col-md-6">
            <h3 class="h2Jaune">CROIRE EN QUI ?</h3>
            <blockquote>
                <p>Je ne suis qu’un enfant, ô mon Dieu,<br>
...
Je pleurerai toute ma pensée<br>
À ceux que la croyance offensait !<br>
...
Je veux pleurer cette bannière<br>
Qu’est la liberté prisonnière !<br><br>

Refrain : Il me faut croire en qui, croire en quoi,<br>
Pour que je ne dise plus : pourquoi ?<br>

Ridé c’est mon futur ô mon Dieu,<br>
À souffrir mon corps trop douloureux !<br>
À souffrir chaque jour d’une messe<br>
La voix de l’hypocrite promesse.<br>
À souffrir dans chaque partition<br>
La note aiguë de la confession ;<br>
Et à souffrir le dernier voyage<br>
D’un compagnon mort de son vieil âge !<br><br>

Refrain : Il me faut croire en quoi, croire en qui,<br>
Pour que je ne dise plus : pour Qui ?<br></p>
            </blockquote>
            <h3 class="h2Jaune">LAVANDIÈRE</h3>
            <blockquote>
                <p>J’accompagne ma mère au lavoir du passé,<br>
...
Tu nettoies le rire audacieux des draps,<br><br>
Tape, tape lavandière,<br>
...
Tu astiques du flirt le premier sang<br>
Tape, tape lavandière,<br>
Et ta fille aux yeux rougissants<br>
Quittera bientôt ta chaumière !<br><br>

Tes gestes sont plus lents ton regard devient noir,<br>
Ta copine soutient ta pensée douloureuse ;<br>
Il faut évacuer l’oubli dans le lavoir<br>
Faire semblant d’avoir une existence heureuse !<br><br>

Tu frictionnes la mort en brossant fort !<br>
Tape, tape lavandière !<br>
Et sourire c’est sans effort<br>
À l’intérieur de ta chaumière !<br></p>
</blockquote>
                </div>
            </div>

            <!-- Deuxième ligne de blockquote -->
            <div class="row">
                <div class="col-md-6">
                <h3 class="h2Jaune">LE FOU ET SA REINE</h3>
            <blockquote>
                <p>Je suis ton fou, tu es ma reine<br>
...
Reste le souvenir,<br>
Reste le souvenir…<br><br>
...
Je suis échec et mat…<br><br>

Au jeu d’ouvertures tu mènes,<br>
Stratège remarquable au regard froid<br>
Tu abats les pions dans tes chaînes<br>
Pour le plaisir de terminer par moi<br>
Je suis ton fou, tu es ma reine<br>
Me ferai plus cavalier que ton roi.<br><br>

Rangeons le plateau dans l’armoire<br>
Afin que les regrets soient moins amers<br>
Ton fou à l’haubert dérisoire<br>
N’écoutera pas l’appel de la mer…<br>
La folie c’est aimer,<br>
La folie c’est aimer…<br><br>
...
A meurtri le pion de mon désarroi<br>
Je suis ton fou, tu es ma reine<br>
Me ferai plus cavalier que ton roi.<br></p>
</blockquote>
                </div>
            </div>

            <!-- Troisième ligne de blockquote -->
            <div class="row">
                <div class="col-md-6">
                <h3 class="h2Jaune">UNE AMPOULE CLAQUE</h3>
            <blockquote>
                <p>Une ampoule claque<br>
...
Dans la paume se fait jour<br>
Ce sourire qui chancelle<br>
Est un beau signe d’amour<br>
Au firmament des étincelles...</p>
                </blockquote>
