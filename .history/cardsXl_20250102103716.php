...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group11" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/patriciaScharff/couv-les-aventures-de-mael-patricia-scharff_1-min.webp" class="img-fluid" alt="Couverture de livre lES AVENTURES DE MAEL , Clémentine">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Patricia Scharff</div>
                    <div class="mobile-book-price">15,00 €</div>
                </div>
