...
<div class="d-block d-md-none">
    ...
    <div id="desktop-group1" class="new-card-container">
        ...
        <div class="new-card">
            <a href="link_to_book_B.html">
                <img src="images/" class="img-fluid" alt="Couverture de livre Les mystères de l'Hometrou">
                <div class="new-card-content">
                    <div class="new-card-author">Brandao Pierre</div>
    ...
    <div id="desktop-group2" class="new-card-container new-hidden">
     ...
     <div id="desktop-group3" class="new-card-container new-hidden">
        ...
        <div class="new-card">
            <a href="link_to_book_G.html">
                <img src="images/patriciaScharff/cou_1-min.webp" class="img-fluid" alt="Couverture de livre lES AVENTURES DE MAEL , Clémentines, Brann et julia">
                <div class="new-card-content">
                    <div class="new-card-author">Brandao Pierre</div>
                    <div class="new-card-price">15,00 €</div>
                </div>
