...
$livres = [
    ...
    // Ajoute ici d'autres livres si nécessaire
];
...
<section class="livres">
    <div class="containerAuteur">
        ...
        <?php foreach ($livresPage as $index => $livre): ?>
            <div id="livre-<?php echo $index + 1; ?>" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="<?php echo $livre['image']; ?>" class="img-fluid w-75" alt="Couverture du livre <?php echo $livre['titre']; ?>">
        ...
        <!-- Boutons de navigation -->
        <div class="livre-navigation d-flex justify-content-center mt-4">
            <button id="livre-backButton" class="livre-button" <?php if ($page == 1) echo 'disabled'; ?>>Précédent</button>
            <button id="livre-nextButton" class="livre-button" <?php if ($page >= $totalPages) echo 'disabled'; ?>>Suivant</button>
        </div>
    </div>
</section>
