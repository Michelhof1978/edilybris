    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <a href="fichePatriceBachereau.php">
                <div class="person">
                    <img src="images/patriceBachereau/patriceBachereaulivre.webp" alt="Photo de Patrice Bachereau" class="photo">
                    <p class="name pb-4">Patrice Bachereau</p>
                </div>
            </a>
        </div>
        ...
        <div class="carousel-item">
            <a href="ficheDavidBeaulieu.php">
                <div class="person">
                    <img src="images/davidBeaulieu/davidBeaulieu.webp" alt="Photo de David Beaulieu" class="photo">
                    <p class="name">David Beaulieu</p>
                </div>
            </a>
        </div>
        ...
        <!-- JOEL BERTHELOT -->
        <div class="carousel-item">
            <a href="FicheJoelBerthelotlivres.php">
                <div class="person">
        ...
        <!-- BESSEDE ARLETTE -->
        <div class="carousel-item">
            <a href="ficheArletteBessedeLivres.php">
                <div class="person">
        ...
        <!-- BRANDAO PIERRE -->
        <div class="carousel-item">
            <a href="FichePierreBrandao.php">
                <div class="person">
                    <img src="images/pierreBrandao/pierreBrandao.webp" alt="Photo de Brandao Pierre" class="photo">
                    <p class="name">Brandao Pierre</p>
                </div>
            </a>
        </div>
...
<div class="carousel-item">
 ...
 <div class="carousel-item">
            <a href="ficheGuyLoPinto.php">
                <div class="person">
                    <img src="images/guyLopinto/guyLopinto.webp" alt="Photo de MAILY JOCELYN" class="photo">
...
<div class="carousel-container d-none d-md-block">
  ...
  <div class="carousel">
    <div class="box">
      <!-- PATRICE BACHEREAU-->
      <a href="fichePatriceBachereau.php" class="profile-card director">
        <div class="imgBx">
          <img src="images/patriceBachereau/patriceBachereau.webp" class="img-fluid" alt="Photo de Patrice Bachereau">
        </div>
        <div class="details mb-3">
          <h2> Patrice Bachereau</h2>
        </div>
      </a>

            <!-- DAVID BEAULIEU-->
      <a href="ficheDavidBeaulieu.php" class="profile-card producer">
        <div class="imgBx">
          <img src="images/davidBeaulieu/davidBeaulieu.webp" class="img-fluid" alt="Photo deDavid Beaulieu">
        </div>
        <div class="details mb-3">
 ...
 <!-- BRANDAO PIERRE-->
      <a href="fichePierreBrandao.php" class="profile-card director">
        <div class="imgBx">
          <img src="images/pierreBrandao/pierreBrandao.webp" class="img-fluid" alt="Photo de BRANDAO PIERRE">
        </div>
        <div class="details mb-3">
          <h2>BRANDAO PIERRE</h2>
        </div>
      </a>
 <!-- BRUNETOT ANNIE-->
      <a href="ficheAnnieBrunetot.php" class="profile-card director">
        <div class="imgBx">
          <img src="images/annieBrunetot/annieBrunetot.webp" class="img-fluid" alt="Gilles Hervé">
        </div>
        <div class="details mb-3">
          <h2>BRUNETOT ANNIE</h2>
        </div>
      </a>
 ...
 <!-- CRETEL JEAN-PIERRE -->
      <a href="ficheJeanPierreCretel.php" class="profile-card director">
        <div class="imgBx">
 ...
 <!-- GALARD FRANCOIS-->
      <a href="ficheFrancoisgalard.php" class="profile-card producer">
        <div class="imgBx">
          <img src="images/francoisGalard/francoisGalard.webp" class="img-fluid" alt="Photo de GALARD FRANCOIS">
        </div>
        <div class="details mb-3">
          <h2>GALARD FRANCOIS</h2>
        </div>
      </a>
 <!-- HERVE GILLES-->
 ...
 <!-- LE GUENNEC LUC-->
      ...
      <a href="ficheGuyLoPinto.php" class="profile-card producer">
        <div class="imgBx">
          <img src="images/guyLopinto/guyLopinto.webp" class="img-fluid" alt="Photo MAILY JOCELYN">
        </div>
        <div class="details mb-3">
          <h2>LO PINTO GUY</h2>
        </div>
