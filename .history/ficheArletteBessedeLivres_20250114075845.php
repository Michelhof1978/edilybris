...
<div class="headerAuteur">
    <div class="containerAuteur">
        ...
        <img src="images/arletteBessede/arletteBessede.webp" alt="Arlette Bessède" class="img-fluid bio-image">
...
<p class="text-center">Arlette Bessède, pérignacienne, se veut avant tout témoin de son univers plutôt que d'une ville en particulier. 
    Elle a une plume sensible à fleur de peau et sait, par une épure du texte, aller à l'essentiel.

Très impliquée dans la vie associative, elle s'occupe de causes nobles comme la place de la femme dans nos sociétés modernes. 
Elle est à l'initiative également de salons féminins sur La Rochelle.
...
<div class="d-block d-md-none">
    ...
    <div id="desktop-group1PierreBrandao" class="new-card-container">
        ...
        <div class="new-card">
        <a href="ficheArletteBessedeLeVentreIriseDeNosRiviere.php">
        <img src="images/arletteBessede/surLeVentreIriséDeNosRivières.webp" class="img-fluid" alt="Couverture de livre Le ventre irisé de nos rivières">
                <div class="new-card-content">
                    <div class="new-card-author">Brandao Pierre</div>
