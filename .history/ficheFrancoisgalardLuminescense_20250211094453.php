...
<title>François Galard- Auteur</title>
<meta name="description" content="Biographie et livres de François Galard. Découvrez ses œuvres et téléchargez un bon de commande.">
</head> 
...
<main>
    ...
    <section class="livres-mobile d-block d-md-none py-4">
        <div class="container">
            <h2 class="text-center text-white">Le livre de François Galard</h2>
    ...
    <span class="fst-italic">de sagesse et de tendresse.</span>
</p>
