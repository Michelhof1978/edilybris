...
<footer class="footer-section d-none d-md-block">
    ...
    <div class="copyright-area text-center">
        <div class="container">
            <div class="row">
                <div class="text-center">
                    <img src="images/logoHarmonyDigital.png" alt="" class="img-fluid w-50">
                    <p>Site r</p>
                    <div class="copyright-text">
                        <p>Copyright &copy; 2022 - <span id="date2"></span> Droits réservés <a href="https://harmony-digital.fr/" target="_blank"><br><span class="pt-5">Site réalisé par Michel Hoffmann <br> Harmony Digital</span></a></p><br>
                        </p>
                    </div>
                </div>
            </div>
