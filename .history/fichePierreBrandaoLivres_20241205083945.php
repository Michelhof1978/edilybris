        ...
        <div class="bio-content">
            ...
            <div class="bio-text">
                ...
                <div class="text-center">
                    <a href="fichePierreBrandaoCitations.php" class="btn" ellow; color: black; border: 1px solid #ccc; font-size: 1.5rem; padding: 15px 30px; border-radius: 8px;">Découvrir les citations</a>
                </div>
            </div>
        </div>
    </div>
