...
<div id="mobile-carousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
      ...
      <div class="mobile-card">
        <a href="link_to_book_A.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">L'écho des collines</div>
            <div class="mobile-card-author">Alice Dubois</div>
            <div class="mobile-card-description">Une histoire captivante au cœur des montagnes.</div>
            <div class="mobile-card-price">16,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="mobile-card">
        <a href="link_to_book_B.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">Les murmures du temps</div>
            <div class="mobile-card-author">Bertrand Martin</div>
            <div class="mobile-card-description">Un voyage à travers les époques et les secrets.</div>
            <div class="mobile-card-price">18,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="mobile-card">
        <a href="link_to_book_F.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">La lumière des ombres</div>
            <div class="mobile-card-author">Fabien Leclerc</div>
            <div class="mobile-card-description">Un thriller captivant à couper le souffle.</div>
            <div class="mobile-card-price">17,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="mobile-card">
        <a href="link_to_book_G.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">Les vagues éternelles</div>
            <div class="mobile-card-author">Gabrielle Blanc</div>
            <div class="mobile-card-description">Un récit émouvant au bord de l'océan.</div>
            <div class="mobile-card-price">13,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="mobile-card">
        <a href="link_to_book_D.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">Sous les cyprès</div>
            <div class="mobile-card-author">Diane Morel</div>
            <div class="mobile-card-description">Un roman poétique entre amour et nature.</div>
            <div class="mobile-card-price">14,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="mobile-card">
        <a href="link_to_book_H.html">
          ...
          <div class="mobile-card-content">
            <div class="mobile-card-title">Le chant des cendres</div>
            <div class="mobile-card-author">Henri Dupont</div>
            <div class="mobile-card-description">Une épopée historique riche en émotions.</div>
            <div class="mobile-card-price">14,99 €</div>
          </div>
        </a>
      </div>
...
<div class="d-none d-md-block">
  <!-- Groupe 1 -->
  <div class="desktop-card-container mb-5" id="desktop-group1">
    <div class="desktop-card">
        <a href="link_to_book_A.html">
            <img src="images/pierreBrandao/leCoeurAsesSaisons.png" class="img-fluid" alt="Livre A">
            <div class="desktop-card-content">
                <div class="desktop-card-title">L'écho des collines</div>
                <div class="desktop-card-author">Alice Dubois</div>
                <div class="desktop-card-description">Une histoire captivante au cœur des montagnes.</div>
                <div class="desktop-card-price">16,99 €</div>
            </div>
        </a>
    </div>
    <div class="desktop-card">
        <a href="link_to_book_B.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre B">
            <div class="desktop-card-content">
                <div class="desktop-card-title">Les murmures du temps</div>
                <div class="desktop-card-author">Bertrand Martin</div>
                <div class="desktop-card-description">Un voyage à travers les époques et les secrets.</div>
                <div class="desktop-card-price">18,99 €</div>
            </div>
        </a>
    </div>
    <div class="desktop-card">
        <a href="link_to_book_D.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre D">
            <div class="desktop-card-content">
                <div class="desktop-card-title">Sous les cyprès</div>
                <div class="desktop-card-author">Diane Morel</div>
                <div class="desktop-card-description">Un roman poétique entre amour et nature.</div>
                <div class="desktop-card-price">14,99 €</div>
            </div>
        </a>
    </div>
  </div>
  ...
  <!-- Groupe 2 -->
  <div class="desktop-card-container desktop-hidden" id="desktop-group2">
    <div class="desktop-card">
        <a href="link_to_book_F.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre F">
            <div class="desktop-card-content">
                <div class="desktop-card-title">La lumière des ombres</div>
                <div class="desktop-card-author">Fabien Leclerc</div>
                <div class="desktop-card-description">Un thriller captivant à couper le souffle.</div>
                <div class="desktop-card-price">17,99 €</div>
            </div>
        </a>
    </div>
    <div class="desktop-card">
        <a href="link_to_book_G.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre G">
            <div class="desktop-card-content">
                <div class="desktop-card-title">Les vagues éternelles</div>
                <div class="desktop-card-author">Gabrielle Blanc</div>
                <div class="desktop-card-description">Un récit émouvant au bord de l'océan.</div>
                <div class="desktop-card-price">13,99 €</div>
            </div>
        </a>
    </div>
    <div class="desktop-card">
        <a href="link_to_book_H.html">
            <img src="images/pierreBrandao/leCoeurAsesSaisons.png" class="img-fluid" alt="Livre H">
            <div class="desktop-card-content">
                <div class="desktop-card-title">Le chant des cendres</div>
                <div class="desktop-card-author">Henri Dupont</div>
                <div class="desktop-card-description">Une épopée historique riche en émotions.</div>
                <div class="desktop-card-price">14,99 €</div>
            </div>
        </a>
    </div>
  ...
  <div class="desktop-navigation">
    <button id="desktop-backButton" class="desktop-button text-white" disabled>Précédent</button>
    <button id="desktop-nextGroupButton" class="desktop-button text-white">Suivant</button>
  </div>
</div>
