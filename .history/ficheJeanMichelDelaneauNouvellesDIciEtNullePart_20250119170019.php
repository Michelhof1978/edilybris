...
">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 132
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 132</p>
...
<h3 class="h2Jaune text-center m-3">Extrait</h3>
                    ...
                    <h4 class="h2Jaune text-center m-3">L’enfer(t</h4>

                   <p class="colorYellow lead"> Avertissement : cet épisode – fictif – de la Guerre du Vietnam (1963-1975) se base néanmoins sur des faits réels, similaires ou approchants...<br>
