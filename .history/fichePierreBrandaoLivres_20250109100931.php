...
<div class="d-block d-md-none">
    ...
    <!-- Groupe 2 SAV GENDARMERIE BONJOUR 1-->
    <div id="desktop-group2" class="new-card-container new-hidden">
        ...
        <div class="new-card">
         ...
         <div class="new-card">
            <a href="link_to_book_J.html">
                <img src="images/jannickWeber/fils-de-coco-pour-site-edilybris.webp" class="img-fluid" alt="Couverture de livre LES RONDS POINTS DE LA COLERE">
                <div class="new-card-content">
