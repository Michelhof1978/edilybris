    ...
    <section class="livres">
        <div class="containerAuteur">
                ...
                <div class="livre">
                    <div class="livre-content">
                        <div class="livre-image">
                            <img src="<?= $livre['image'] ?>" class="img-fluid w-75" alt="Couverture du livre <?= $livre['titre'] ?>">
            ...
            <div class="livre-navigation d-flex justify-content-center mt-4">
                <?php if ($page > 1): ?>
                    <a href="?page=<?= $page - 1 ?>" class="livre-button">Précédent</a>
                <?php else: ?>
                    <button class="livre-button" disabled>Précédent</button>
                <?php endif; ?>

                <?php if ($page < $totalPages): ?>
                    <a href="?page=<?= $page + 1 ?>" class="livre-button">Suivant</a>
                <?php else: ?>
                    <button class="livre-button" disabled>Suivant</button>
                <?php endif; ?>
            </div>
        </div>
    </section>
