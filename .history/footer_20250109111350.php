...
document.addEventListener('DOMContentLoaded', function () {
    // Variables pour les boutons et les groupes de livres
    const mobileBackBtnPierreBrandao = document.getElementById('mobile-back-btn-pierre-brandao');
    const mobileNextBtnPierreBrandao = document.getElementById('mobile-next-btn-pierre-brandao');
    const desktopBackBtnPierreBrandao = document.getElementById('new-desktop-backButton-pierre-brandao');
    const desktopNextBtnPierreBrandao = document.getElementById('new-desktop-nextGroupButton-pierre-brandao');
    // Ajout de 30 groupes pour mobile
    const mobileGroups = Array.from({ length: 40 }, (_, i) =>
        document.getElementById(`mobile-group${i + 1}`)
    );
