<?php include("head.php"); ?>
 ...
 <div class="book-carousel" id="bookCarousel">
    <!-- Première Partie: les 5 premières cartes -->
    ...
    <!-- Partie suivante: affichera les 5 suivantes lorsque nécessaire -->
    <div class="carousel-items">
        <!-- Card 6 -->
        <div class="book-card">
            <a href="auteurs/pierreBrandao.html">
    ...
    <!-- Flèches pour défilement -->
    <button id="prev" class="carousel-control" onclick="prevSlide()">❮</button>
    <button id="next" class="carousel-control" onclick="nextSlide()">❯</button>
</div>
