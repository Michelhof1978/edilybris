...
<div class="carousel-controls d-flex justify-content-center mt-4">
    <button class="carousel-control-prev btn btn-primary" type="button" data-bs-target="#carouselLivres" data-bs-slide="prev">
        Précédent
    </button>
    <button class="carousel-control-next btn btn-primary" type="button" data-bs-target="#carouselLivres" data-bs-slide="next">
        Suivant
    </button>
</div>
