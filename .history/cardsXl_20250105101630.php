...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group32" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/abdelFrançoisNadini/dlball-recto-seul-br (1)_11zon.webp" class="img-fluid" alt="Couverture de livre Dela bougie aux projecteurs">
                <div class="mobile-book-details">
    ...
    <div id="mobile-group33" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/alainTahet/couv-recto-lcadli (1)_11zon_11zon.webp" class="img-fluid" alt="Couverture de livre Dela bougie aux projecteurs">
                <div class="mobile-book-details">
