...
function updateDesktopScroll() {
  // Déplacement du conteneur des groupes de cartes
  const groupWidth = desktopGroups[0].offsetWidth + parseInt(window.getComputedStyle(desktopGroups[0]).marginRight); // Largeur d'un groupe de cartes
  desktopContainer.scrollLeft = currentDesktopIndex * groupWidth;
