...
<script>
// SCRIPT COMMUN POUR MOBILE ET DESKTOP
document.addEventListener("DOMContentLoaded", function () {
    // Initialisation des paramètres pour Desktop
    let currentDesktopGroup = 1; // Commence avec le premier groupe
    const totalDesktopGroups = 3; // Nombre total de groupes desktop
    ...
    // Fonction pour afficher un groupe Desktop
