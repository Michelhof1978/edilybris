...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const mobileGroups = [
        ...
        document.getElementById('mobile-group11'),
        document.getElementById('mobile-group12'),
        document.getElementById('mobile-group13'),
        document.getElementById('mobile-group14'),
        document.getElementById('mobile-group15'),
        document.getElementById('mobile-group16'),
        document.getElementById('mobile-group17'),
    ];
