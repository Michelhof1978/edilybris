...
<main>
    ...
    <section class="livres-mobile d-block d-md-none py-4">
        <div class="container">
            ...
            <!-- Livre 1 : Meurtre à la microcarte -->
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/pierreBrandao/couv-recto-malmc-pour-internet-br-2-min-min.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">22,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Meurtre à la microcarte</h3>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2018
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 350
                    </p>
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Policier
                    </p>
                    <p>
                        <strong class="h2Jaune">Référence :</strong> 9782363440266
                    </p>
                    <p class="lead">
    <strong class="h2Jaune">Résumé :</strong> Laissons la parole à Jocelyn Maily, l'auteur de Loozana Blues, et membre du comité de lecture d'Edi'lybris...
</p>

***

<p>
    Elle croyait avoir tout vu.<br>
    Tout.<br>
    Elle pensait avoir tout supporté.<br>
    Tout.<br>
    Elle était certaine d'être capable de tout endurer.<br><br>

    Mais Isabelle va découvrir qu'il n'en est rien.<br><br>

    Cette fois-ci, elle va devoir affronter sa propre mort.<br>
    Et ça n'est que le début.<br>
...
<p>
    À Port-d'Envaux, en Charente-Maritime, les carrières de calcaire s'offrent aux doigts experts de sculpteurs de pierre.<br>
    L'un d'eux rencontre l'édile du coin, un député.<br>
    Discrètement, il lui confie une micro-carte, mais celle-ci tombe sans qu'aucun des deux hommes s'en aperçoive.<br>
    Dans l'assistance, un hacker a tout vu.<br>
    Il subtilise l'objet, rentre chez lui et se précipite sur son ordinateur.<br>
    Le lendemain, on le retrouve mort sur sa table de travail...<br><br>

    Le moniteur est allumé : une invite exige un mot de passe, mais personne ne le connaît...
</p>
                    ...
                    <p>
    Cimetière Saint-Éloi, La Rochelle,<br>
    Lundi 16 février 2015, 10 h 00.<br><br>
...
<p>
    L’épitaphe sobre résumait sa vie.<br><br>

    Isabelle LOUBRY<br>
    40 ans- Majore de gendarmerie à titre posthume<br>
    Née le 1er mai 1971 – décédée le 13.02.2015.<br><br>
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 350</p>
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 9782363440266</p>

                        <p class="lead text-white">
    Laissons la parole à Jocelyn Maily, l'auteur de <em>Loozana Blues</em>, et membre du comité de lecture d'Edi'lybris...
</p>
...
<p>
    À Port-d'Envaux, en Charente-Maritime, les carrières de calcaire s'offrent aux doigts experts de sculpteurs de pierre. L'un d'eux rencontre l'édile du coin, un député. Discrètement, il lui confie une micro-carte, mais celle-ci tombe sans qu'aucun des deux hommes s'en aperçoive. Dans l'assistance, un hacker a tout vu. Il subtilise l'objet, rentre chez lui et se précipite sur son ordinateur. Le lendemain, on le retrouve mort sur sa table de travail...
</p>
