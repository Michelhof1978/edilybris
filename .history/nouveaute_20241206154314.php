...
<div id="custom-carousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
      ...
      <div class="custom-card">
        <a href="link_to_book_A.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">L'écho des collines</div>
            <div class="custom-card-author">Alice Dubois</div>
            <div class="custom-card-description">Une histoire captivante au cœur des montagnes.</div>
            <div class="custom-card-price">16,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item d-flex justify-content-center align-items-center">
      <div class="custom-card">
        <a href="link_to_book_B.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">Les murmures du temps</div>
            <div class="custom-card-author">Bertrand Martin</div>
            <div class="custom-card-description">Un voyage à travers les époques et les secrets.</div>
            <div class="custom-card-price">18,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item d-flex justify-content-center align-items-center">
      <div class="custom-card">
        <a href="link_to_book_F.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">La lumière des ombres</div>
            <div class="custom-card-author">Fabien Leclerc</div>
            <div class="custom-card-description">Un thriller captivant à couper le souffle.</div>
            <div class="custom-card-price">17,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item d-flex justify-content-center align-items-center">
      <div class="custom-card">
        <a href="link_to_book_G.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">Les vagues éternelles</div>
            <div class="custom-card-author">Gabrielle Blanc</div>
            <div class="custom-card-description">Un récit émouvant au bord de l'océan.</div>
            <div class="custom-card-price">13,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item d-flex justify-content-center align-items-center">
      <div class="custom-card">
        <a href="link_to_book_D.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">Sous les cyprès</div>
            <div class="custom-card-author">Diane Morel</div>
            <div class="custom-card-description">Un roman poétique entre amour et nature.</div>
            <div class="custom-card-price">14,99 €</div>
          </div>
        </a>
      </div>
    </div>
    ...
    <div class="carousel-item d-flex justify-content-center align-items-center">
      <div class="custom-card">
        <a href="link_to_book_H.html">
          ...
          <div class="custom-card-content">
            <div class="custom-card-title">Le chant des cendres</div>
            <div class="custom-card-author">Henri Dupont</div>
            <div class="custom-card-description">Une épopée historique riche en émotions.</div>
            <div class="custom-card-price">14,99 €</div>
          </div>
        </a>
      </div>
