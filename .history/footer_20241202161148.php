...
const cards = document.querySelectorAll(".xl-card");
const nextButton = document.getElementById("xl-nextGroupButton");
const backButton = document.getElementById("xl-backButton");

function showCard(index) {
    // Cache toutes les cartes
    cards.forEach((card, i) => {
        card.classList.add("xl-hidden");
    });

    // Affiche la carte courante
    cards[index].classList.remove("xl-hidden");
...
// Affiche la première carte au départ
