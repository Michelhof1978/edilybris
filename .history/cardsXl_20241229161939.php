...
<div class="d-block d-md-none mb-3">
    ...
    <div id="new-group5" class="new-card-container new-hidden">
        <div class="new-card">
            <a href="link_to_book_F.html">
                <img src="images/jeanPierreCretel/parfois-les-vagues-couv.webp" class="img-fluid" alt="Couverture de livre Parfois les vagues">
                <div class="new-card-content">
                    <div class="new-card-author">Cretel Jean-Pierre</div>
    ...
    <div id="new-group7" class="new-card-container new-hidden">
        <div class="new-card">
            <a href="link_to_book_F.html">
                <img src="images/gillesHerve/couv-pourquoi-ecrit-on-gilles-herve.webp" class="img-fluid" alt="Couverture de livre Pourquoi écrit-on ?">
                <div class="new-card-content">
    ...
    <div id="new-group9" class="new-card-container new-hidden">
        <div class="new-card">
            <a href="link_to_book_F.html">
                <img src="images/jeanMichelDelaneau/Couv-Recto-Nouvelles-d_ici.webp" class="img-fluid" alt="Couverture de livre Nouvelles d'ici et nulle part">
                <div class="new-card-content">
    ...
    <div class="new-navigationMobile">
        <button id="new-mobile-backButtonMobile" class="new-button xl-button text-white" disabled>Précédent</button>
        <button id="new-mobile-nextGroupButtonMobile" class="new-button xl-button text-white">Suivant</button>
    </div>
</div>
    ...
    <div id="desktop-group3" class="new-card-container new-hidden">
        ...
        <div class="new-card">
            <a href="link_to_book_K.html">
                <img src="images/sample/sample11.webp" class="img-fluid" alt="Couverture de livre Book 11">
                <div class="new-card-content">
                    <div class="new-card-author">Author 11</div>
        ...
        <div class="new-card">
            <a href="link_to_book_L.html">
                <img src="images/sample/sample12.webp" class="img-fluid" alt="Couverture de livre Book 12">
                <div class="new-card-content">
                    <div class="new-card-author">Author 12</div>
                    <div class="new-card-price">17,00 €</div>
                </div>
            </a>
        </div>
        ...
        <div class="new-card">
            <a href="link_to_book_M.html">
                <img src="images/sample/sample13.webp" class="img-fluid" alt="Couverture de livre Book 13">
                <div class="new-card-content">
                    <div class="new-card-author">Author 13</div>
                    <div class="new-card-price">15,00 €</div>
                </div>
            </a>
        </div>
        ...
        <div class="new-card">
            <a href="link_to_book_N.html">
                <img src="images/sample/sample14.webp" class="img-fluid" alt="Couverture de livre Book 14">
                <div class="new-card-content">
                    <div class="new-card-author">Author 14</div>
        ...
        <div class="new-card">
            <a href="link_to_book_O.html">
                <img src="images/sample/sample15.webp" class="img-fluid" alt="Couverture de livre Book 15">
                <div class="new-card-content">
                    <div class="new-card-author">Author 15</div>
    ...
    <div id="desktop-group4" class="new-card-container new-hidden">
        <!-- carte 16 -->
        <div class="new-card">
            <a href="link_to_book_P.html">
                <img src="images/sample/sample16.webp" class="img-fluid" alt="Couverture de livre Book 16">
                <div class="new-card-content">
                    <div class="new-card-author">Author 16</div>
                    <div class="new-card-price">19,00 €</div>
                </div>
            </a>
        </div>
        <!-- carte 17 -->
        <div class="new-card">
            <a href="link_to_book_Q.html">
                <img src="images/sample/sample17.webp" class="img-fluid" alt="Couverture de livre Book 17">
                <div class="new-card-content">
                    <div class="new-card-author">Author 17</div>
                    <div class="new-card-price">14,00 €</div>
                </div>
            </a>
        </div>
        <!-- carte 18 -->
        <div class="new-card">
            <a href="link_to_book_R.html">
                <img src="images/sample/sample18.webp" class="img-fluid" alt="Couverture de livre Book 18">
                <div class="new-card-content">
                    <div class="new-card-author">Author 18</div>
        ...
        <!-- carte 19 -->
        <div class="new-card">
            <a href="link_to_book_S.html">
                <img src="images/sample/sample19.webp" class="img-fluid" alt="Couverture de livre Book 19">
                <div class="new-card-content">
                    <div class="new-card-author">Author 19</div>
        ...
        <!-- carte 20 -->
        <div class="new-card">
            <a href="link_to_book_T.html">
                <img src="images/sample/sample20.webp" class="img-fluid" alt="Couverture de livre Book 20">
                <div class="new-card-content">
                    <div class="new-card-author">Author 20</div>
    ...
    <div class="new-navigationDesktop">
        <button id="new-desktop-backButtonDesktop" class="new-button xl-button text-white" disabled>Précédent</button>
        <button id="new-desktop-nextGroupButtonDesktop" class="new-button xl-button text-white">Suivant</button>
    </div>
</div>
