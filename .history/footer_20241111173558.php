        ...
        <div class="container">
            <div class="row">
                <div class="text-center">
                    ...
                    <p>Site r</p>
                    <div class="copyright-text">
                        <p>Copyright &copy; 2022 - <span id="date2"></span>, Droits réservés <a href="https://harmony-digital.fr/" target="_blank"><br><span class="pt-5">Site réalisé par Michel Hoffmann <br> Harmony Digital</span></a></p>
                        </p>
                    </div>
                </div>
            </div>
