...
<div id="book-carousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
  ...
  <!-- Contrôles de navigation en dessous -->
  <div class="new-navigation mt-3 text-center">
    <button class="carousel-control-prev new-button xl-button text-white me-2" type="button" data-bs-target="#book-carousel" data-bs-slide="prev">
      Précédent
    </button>
    <button class="carousel-control-next new-button xl-button text-white ms-2" type="button" data-bs-target="#book-carousel" data-bs-slide="next">
      Suivant
    </button>
  </div>
</div>
