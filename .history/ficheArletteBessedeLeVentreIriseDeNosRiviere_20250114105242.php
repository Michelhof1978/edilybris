        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/arletteBessede/surLeVentreIriseDeNosRivières.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">12,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center"></h3>Sur le ventre de nos rivières</h3>
                    <p>
                    ...
                    <img src="images/arletteBessede/couverture-comple-te-recueil-ab-slvidnr_11zon.webp" class="img-fluid w-100 mb-3 d-block mx-auto" alt="Illustration">

                    <p class="lead">
                        <strong class="h2Jaune">Résumé :</strong>Ce troisième recueil d’Arlette Bessède entraîne le lecteur dans un monde introspectif jusqu’à l’exploration de l’intime. Dès la première strophe, le ton est donné :
...
<h4 class="h2Jaune text-center m-3">Retours de lecture</h4>
...
<strong class="h2Jaune">Résumé :</strong>Jean-Pierre : L'écriture est très personnelle, sensible. Rien ne s'oppose à l'accomplissement des poésies en recueil.

<strong class="h2Jaune">Résumé :</strong>Nicole : Ce petit recueil de poésie m'a réchauffé le cœur et l'esprit ce dont j'ai tant besoin en ce moment, merci.

<strong class="h2Jaune">Résumé :</strong>Alain : rayons de soleil dans la grisaille ambiante, ces poésies donnent envie de jardins, de fleurs et de voyages. J'aime beaucoup.

<strong class="h2Jaune">Résumé :</strong>Monica : Je réagis sur l'ouvrage poétique d'Arlette qui me semble (à mon humble avis) très agréable à lire et à entendre. Je ne suis pas qualifiée pour juger de la technique, mais à mes oreilles je le trouve rythmé et chantant. Bref...vous aurez compris que je donne mon aval sur l'édition de cet ouvrage..

<strong class="h2Jaune">Résumé :</strong>Jacqueline : tout à fait d’accord avec le commentaire de Monica… c’est souple et bien écrit, je ne peux juger du fond (qui n’est pas une nouveauté en soi dans le monde de la poésie, mais pourquoi pas?)
...
ton beau visage ma déchirure
                    ...
                    <div class="text-center mt-3">
                        <a href="images/bulletin-de-commande-2024.pdf" class="btn btn-warning fw-bold text-white w-50" download>Télécharger le bon de commande</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/arletteBessede/surLeVentreIriseDeNosRivières.webp" class="img-fluid" alt="Couverture du livre Elle comme liberte">
                    ...
                    <div class="livre-details">
                        <h3 class="h2Jaune">Sur le ventre de nos rivières</h3>
                        ...
                        <img src="images/arletteBessede/couverture-comple-te-recueil-ab-slvidnr_11zon.webp" class="img-fluid  mb-3 d-block mx-auto w-100" alt="Illustration">
