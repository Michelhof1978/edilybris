  ...
  <h2>Slick Carousel Example<h2>
    <div class="carousel2">
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="https://lorempixel.com/200/200/abstract/1">
          </div>
      ...
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="https://lorempixel.com/200/200/abstract/2">
          </div>
          <div class="card-body2">
            <div class="card-content2">
      ...
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="https://lorempixel.com/200/200/abstract/3">
          </div>
          <div class="card-body2">
            <div class="card-content2">
      ...
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="https://lorempixel.com/200/200/abstract/4">
          </div>
          <div class="card-body2">
            <div class="card-content2">
      ...
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="https://lorempixel.com/200/200/abstract/5">
          </div>
          <div class="card-body2">
            <div class="card-content2">
      ...
      <div>
        <div class="card2">
          <div class="card-header2">
            <img class="img2" src="images/pierreBrandao/XLlamourafleurdame.png">
          </div>
          <div class="card-body2">
            <div class="card-content2">
