...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const pierreBrandaoDesktopGroups = [
        ...
        document.getElementById('desktop-group6PierreBrandao'),
        document.getElementById('desktop-group7PierreBrandao'),
        document.getElementById('desktop-group8PierreBrandao'),
    ];
