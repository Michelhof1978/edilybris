...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateMobileButtons() {
        ...
        if (currentMobileGroup === mobileGroups.length - 1) {
            ...
            mobileNextBtn.classList.add('disabled-btn');
        } else {
            mobileNextBtn.disabled = false;
            mobileNextBtn.classList.remove('disabled-btn');
        }
    }
    ...
    function updateDesktopButtons() {
        ...
        if (currentDesktopGroup === desktopGroups.length - 1) {
            ...
            desktopNextBtn.classList.add('disabled-btn');
        } else {
            desktopNextBtn.disabled = false;
            desktopNextBtn.classList.remove('disabled-btn');
        }
    }
