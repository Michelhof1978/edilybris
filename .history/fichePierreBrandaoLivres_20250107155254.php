...
Alors, continuez de rire, partager, faites-vous plaisir ! Évitez simplement qu’un jour, ce Bob, ce soit vous !</p>
    ...
    <h3 class="h2Jaune text-center">Extraits</h3>
    <h4><strong class="h2Jaune">RIDE LIKE THE WINE</strong></h4> 
  <div class="text-center">
        <img class="img-fluid w-50 mb-3" src="images/pierreBrandao/ride-like-the-wine-2.webp" alt="Image centrée">
    </div>

<p class="text-white m-3">Samedi 14 mai 2022 vers 23 heures 15, alors qu’ils patrouillent sur la RD 725 du côté de Faye-l’Abbesse, les gendarmes de Bressuire sont les témoins d’un « spectacle » routier plutôt insolite.
