...
<div class="d-block d-md-none mb-3">
    ...
    <div class="new-navigation1">
        <button id="new-mobile-backButton1" class="new-button xl-button text-white" disabled>Précédent</button>
        <button id="new-mobile-nextGroupButton1" class="new-button xl-button text-white">Suivant</button>
    </div>
</div>
    ...
    <!-- Boutons de navigation -->
    <div class="new-navigation2">
        <button id="new-desktop-backButton2" class="new-button xl-button text-white" disabled>Précédent</button>
        <button id="new-desktop-nextGroupButton2" class="new-button xl-button text-white">Suivant</button>
    </div>
</div>
</div>