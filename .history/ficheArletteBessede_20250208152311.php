...
<p class="text-center text-center">Arlette Bessède, pérignacienne, se veut avant tout témoin de son univers plutôt que d'une ville en particulier. <br>
...
<div class="d-block d-md-none">
    ...
    <div id="desktop-group1PierreBrandao" class="new-card-container">
        ...
        <!-- carte 3 Sur Le Ventre Irise De Nos Riviere-->
        <div class="new-card">
        <a href="ficheArletteBessedeLeVentreIriseDeNosRiviere.php">
