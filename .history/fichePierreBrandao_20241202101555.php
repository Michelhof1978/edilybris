...
<main>
    ...
    <div class="containerAuteur">
        ...
        <!-- Carrousel -->
        <div id="livresCarousel" class="carousel slide" data-bs-ride="false"> <!-- data-bs-ride="false" pour désactiver le défilement automatique -->
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <div class="livre">
                        <img src="images/pierreBrandao/XXlivre3.png" class="img-fluid w-75" alt="Couverture du livre 3">
                        <div class="details">
