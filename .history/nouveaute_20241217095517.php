    ...
    <div class="carousel-item active">
      <div class="book-card">
        <a href="link_to_book_A.html">
          <img src="images/joelBerthelot/couverture-avec-titre-jtedte.webp" class="img-fluid" alt="Couverture de livre ">
    ...
    <div class="carousel-item">
      <div class="book-card">
        <a href="link_to_book_B.html">
          <img src="images/pierreBrandao/couvlenlevement-pierre-brandaobr-pour-site.webp" class="img-fluid" alt="Couverture de livre">
          <div class="book-card-content">
    ...
    <div class="carousel-item">
      <div class="book-card">
        <a href="link_to_book_F.html">
          <img src="images/annieBrunetot/couvrectovvlbsjys.webp" class="img-fluid" alt="Couverture de livre">
          <div class="book-card-content">
...
<div class="L-card-container mb-5" id="L-group1">
    ...
    <div class="L-card">
        <a href="link_to_book_D.html">
            <img src="images/annieBrunetot/couvrectovvlbsjys.webp" class="img-fluid" alt="Livre D">
            <div class="L-card-content">
