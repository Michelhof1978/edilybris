...
<div class="L-card-container L-hidden" id="L-group2">
   <!-- Carte 4 CHRISTINE KUNZ -->
    ...
    <!-- Groupe 3 JOCELYN MAILY-->
<div class="L-card-container L-hidden" id="L-group3">
   <!-- Carte 7  -->
    <div class="L-card">
        <a href="link_to_book_F.html">
            <img src="images/JocelynMailly/cover-loozana-1-pour-site-br_11zon.webp" class="img-fluid" alt="couverture de livre Abreuver le fou qui dort en nos désert">
            <div class="L-card-content">
