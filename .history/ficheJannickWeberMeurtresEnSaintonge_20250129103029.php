        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/jannickWeber/meurtreEnSaintonge.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre                 <div class="col-12 text-white">
">
                    <p class="fw-bold coloryellow fs-5">18,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h4 class="h2Jaune text-center">MEURTRES EN SAINTONGE ou l'impossible descendance</h4>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2012
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 256<br><br>
                        <strong class="h2Jaune">Référence :</strong> 9782363440068
                    </p>
                    <p>
...
Coût : 9 euros - adresser un mail à l'éditeur : edilybris@gmail.com pour les modalités.
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/jannickWeber/meurtreEnSaintonge.webp" class="img-fluid" alt="Couverture du livre CISAILLER DU ROCHER">
                    ...
                    <div class="livre-details">
                        <h3 class="h2Jaune">MEURTRES EN SAINTONGE ou l'impossible descendance</h3>
                        <p class="annee text-white"><strong class="h2Jaune">Année de publication :</strong> 2012</p>
                        <p class="annee text-white"><strong class="h2Jaune">Genre :</strong> Policier</p>
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 256</p><br><br>
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 9782363440068</p>
...
Au travers de cette saga prenante à plus d’un titre, Jannick Weber-Denéchaud restitue à la perfection le lourd climat de défiance, d’indifférence, de haine parfois, qui régit les interactions entre individus de mondes totalement opposés. Entre ces gens simples, voire frustrés, et ces seigneurs parvenus, rustres et implacables, dont elle dresse des portraits saisissants au fil de l’enquête conduite par un « patron » de gendarmerie locale, on est surpris de voir comment l’émotion parvient à s’insinuer et à s’imposer inlassablement sur le devant de la scène, dans toute sa sincérité, pour nous arracher des larmes du cœur et nous inviter à nous interroger sur les fondements de l’existence."</p>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/4kWeJnRPvCs?si=OnTGdWufNhRKX4if" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/viXvKO5IfGU?si=Ftp2DYRzowZBB2BX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>  
<div class="text-center mt-3">
                        <a href="images/bulletin-de-commande-2024.pdf" class="btn btn-warning fw-bold text-white" download>Télécharger le bon de commande</a>
                    </div>                    </div>
                </div>
