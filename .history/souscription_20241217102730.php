...
<div class="text-center">
        <img class="img-fluid mb-3" src="images/promos.webp" alt="Image centrée">
    </div>
        ...
        <a href="link_to_book_A.html">
            ...
            <div class="L-card-content">
                ...
                <div class="L-card-price">
                    <span class="L-price-old" style="text-decoration: line-through; color: red;">20,00 €</span>
                    <span class="L-price-new" style="font-weight: bold; color: green; margin-left: 10px;">18,00 €</span>
                </div>
            </div>
        </a>
    </div>
