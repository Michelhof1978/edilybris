        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                ...
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Cabossées</h3>
                    <p>
...
Ceux qui la suivent reconnaîtront son style libre et atypique.
</p>
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/veroniqueAsh/capture-d-e-cran-2023-08-15-a-10.55.35 (1)-min.webp" class="img-fluid" alt="Couverture du livre carabistouilles">
