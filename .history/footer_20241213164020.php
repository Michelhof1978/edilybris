            ...
            <div class="row">
                <div class="text-center">
                    ...
                    <div class="copyright-text">
                        <p>Copyright &copy; 2010 - <span id="date"></span>, Droits réservés <a href="https://harmony-digital.fr/" target="_blank"><br><span class="pt-5">Site réalisé par Michel Hoffmann <br> Harmony Digital</span></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <div class="copyright-area text-center">
        <div class="container">
            <div class="row">
                <div class="text-center logoHarmony">
                <a href="https://harmony-digital.fr/" target="_blank" rel="noopener noreferrer">
    <img src="images/logoHarmonyDigital.png" alt="Logo Harmony Digital" class="img-fluid w-50">
</a>
                    <div class="copyright-text">
                        <p>
