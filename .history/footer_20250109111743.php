...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateMobileButtonsPierreBrandao() {
        ...
        mobileNextBtnPierreBrandao.disabled = currentMobileGroupPierreBrandao === mobileGroupsPierreBrandao.length - 2;
    }
    // Mise à jour de l'état des boutons desktop
    function updateDesktopButtonsPierreBrandao() {
        desktopBackBtnPierreBrandao.disabled = currentDesktopGroup === 0;
        desktopNextBtnPierreBrandao.disabled = currentDesktopGroup === desktopGroups.length - 1;
    }
    // Navigation mobile : précédent
    mobileBackBtn.addEventListener('click', function () {
        if (currentMobileGroup > 0) {
