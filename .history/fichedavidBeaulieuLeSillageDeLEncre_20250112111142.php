        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/davidBeaulieu/couv-le-sillage-de-l-encre-1.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre La grande prophétie">
                    <p class="fw-bold coloryellow fs-5">18,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Le sillage </h3>
                    <p>
