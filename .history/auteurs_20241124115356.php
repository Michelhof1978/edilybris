 ...
 <script>
   const lGroup1 = document.getElementById('l-group1');
    ...
    function updateGroups() {
      lGroup1.classList.toggle('xl-hidden', currentGroup !== 1);
      lGroup2.classList.toggle('xl-hidden', currentGroup !== 2);

      lBackButton.disabled = currentGroup === 1;
      lNextGroupButton.disabled = currentGroup === 2;
    }
</script>
