        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Référence :</strong> 9782363440396
                    </p>

                    <p class="lead">
    <strong class="h2Jaune">Résumé :</strong> LUCIOLES MAGIQUES est le deuxième fruit d'une rencontre avec Marie, rencontrée sur un des innombrables fils du net.<br> 
    De la passion des mots et des images ce recueil emporte le lecteur dans les sentiments troubles de la vie ; plutôt d'écriture libre, les thèmes évoqués ne pourront pas laisser indifférent.<br><br>
...
<h3 class="h2Jaune text-center m-3">EXTRAIT DU RECUEIL</h3>
<p>
<p class=" m-2 h2jaune" ><strong>Miroir de mes saisons </strong></p>
