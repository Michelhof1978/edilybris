...
// La largeur d'une carte (en pixels)
const cardWidth = document.querySelector('.profile-card').offsetWidth + 20;  // 20px pour l'espacement

// Nombre de cartes visibles à l'écran
const visibleCards = Math.floor(box.offsetWidth / cardWidth);
...
leftArrow.addEventListener('click', () => {
  ...
  const newTransform = `translateX(${translateX + cardWidth * visibleCards}px)`;
