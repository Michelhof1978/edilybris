...
<!-------------------------------------------------------------------------------------->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 mx-auto" src="images/veroniqueAsh/caroussel1.webp" alt="Photos de Veronique Ash">
    </div>
    <div class="carousel-item">
      <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel2.webp" alt="Photo ancienne de Veronique Ash">
    </div>
    <div class="carousel-item">
      <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel3.webp" alt="Photo ancienne de Veronique Ash">
    </div>
    <div class="d-block w-50 mx-auto">
      <img class="d-block w-75" src="images/veroniqueAsh/caroussel4.webp" alt="Photo ancienne de Veronique Ash">
    </div>
    <div class="carousel-item">
      <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel5.webp" alt="Photo ancienne de Veronique Ash">
    </div>
    <div class="carousel-item">
      <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel6.webp" alt="Photo ancienne de Veronique Ash">
    </div>
  </div>
