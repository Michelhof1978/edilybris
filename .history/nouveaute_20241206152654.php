...
<!-- CSS pour ajuster le carrousel -->
<style>
  /* S'assurer que chaque item du carrousel prend toute la largeur du conteneur */
  ...
  #L-carousel .carousel-item {
    width: 100%;  /* Chaque carte occupe toute la largeur */
    max-width: 500px;  /* Vous pouvez ajuster cette valeur pour la taille des cartes */
    display: flex;
    justify-content: center;
    align-items: center;
  }
