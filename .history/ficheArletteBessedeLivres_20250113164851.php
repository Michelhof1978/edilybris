...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group1PierreBrandao" class="mobile-books-container">
        <div class="mobile-book-card">
            <a href="ficheArletteBessedeMesMotsSontDesPaysage.php">
                <img src="images/arletteBessede/mesMotsSontDesPaysages.webp" class="img-fluid" alt="Couverture de livre L'amuserie">
    ...
    <div id="mobile-group2PierreBrandao" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="ficheArletteBessedeElleCommeLiberte.php">
                <img src="images/arletteBessede/couv-recto-elles-comme-liberte-br-pour-site.webp" class="img-fluid" alt="Couverture de livre SAV GENDARMERIE BONJOUR 2 ">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Arlette Bessède</div>
    ...
    <div id="mobile-group3PierreBrandao" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="fichePierreBrandaoSurLeVentreIriseDeNosRiviere.php">
                <img src="images/arletteBessede/surLeVentreIriséDeNosRivières.webp" class="img-fluid" alt="Couverture de livre L'enlèvement">
                <div class="mobile-book-details">
    ...
    <div id="desktop-group1PierreBrandao" class="new-card-container">
        ...
        <div class="new-card">
            <a href="ficheArletteBessedeMesMotsSontDesPaysage.php">
                <img src="images/arletteBessede/mesMotsSontDesPaysages.webp" class="img-fluid" alt="Couverture de livre  L'enlèvement">
