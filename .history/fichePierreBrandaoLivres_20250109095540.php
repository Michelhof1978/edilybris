...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group7" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_B.html">
                <img src="images/pierreBrandao/couv-sav-gie-bjr-2-recto.webp" class="img-fluid" alt="Couverture de livre VENGEANCE SECULAIRE">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Brandao Pierre</div>
                    <div class="mobile-book-price">22 €</div>
                </div>
            </a>
        </div>
    </div>
