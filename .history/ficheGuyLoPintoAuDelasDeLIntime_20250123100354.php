     ...
     <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="d-block w-50 mx-auto" src="images/guyLopinto/carousel2.webp" alt="Photo ancienne de Veronique Ash">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-50 mx-auto" src="images/guyLopinto/carousel3.webp" alt="Peinture artistique">
                </div>
                <div class="carousel-item ">
                ...
                <div class="carousel-item">
                    <img class="d-block w-50 mx-auto" src="images/veroniqueAsh/caroussel6.webp" alt="Peinture artistique">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-50 mx-auto" src="images/veroniqueAsh/caroussel7.webp" alt="Peinture artistique">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-50 mx-auto" src="images/veroniqueAsh/caroussel8.webp" alt="Peinture artistique">
                </div>
...
<div class="text-center mt-3">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel4.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel5.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel6.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel7.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/caroussel8.webp" alt="Peinture artistique">
        </div>
    </div>
