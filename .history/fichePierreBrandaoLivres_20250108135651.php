...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group3" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_C.html">
                <img src="images/" class="img-fluid" alt="Couverture de livre Recette pour un spectacle">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Brandao Pierre</div>
    ...
    <div id="mobile-group4" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_D.html">
                <img src="images/" class="img-fluid" alt="Couverture de livre Sentier de traverses">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Brandao Pierre</div>
                    <div class="mobile-book-price">12,00 €</div>
                </div>
    ...
    <div id="mobile-group5" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_E.html">
                <img src="images/" class="img-fluid" alt="Couverture de livre Parfois les vagues">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Brandao Pierre</div>
    ...
    <div id="mobile-group9" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/" class="img-fluid" alt="Couverture de livre Jannick Weber Denechaud">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Brandao Pierre </div>
    ...
    <div id="mobile-group12" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="imagesarff_1-min.webp" class="img-fluid" alt="Couverture de livre lES AVENTURES DE MAEL , Clémentines, Brann et julia">
                <div class="mobile-book-details">
