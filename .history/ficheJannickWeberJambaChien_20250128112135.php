...
">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 266<br><br>
                        <strong class="h2Jaune">Référence :</strong> 9782363440259
                    </p>
                    <p>
...
<p class="coloryellow lead text-center">Cela vous dirait d’entendre dix fois par jour « arrête de trainer dans mes pattes » ? Je sais bien que ce n’est pas recommandé, mais dans mon cas, ça devient salutaire ! En effet, je prête mes yeux à ma maîtresse et je la conduis là où elle le désire en la sécurisant le plus possible... Mais avant d’en arriver là, il m’en a fallu du chemin ! <br>Je vous propose d’en faire un bout avec moi, tout en découvrant mon existence de chienne destinée à aider les personnes mal-voyantes ou aveugles... Plongez dans mon intimité timide et dévouée, vous craquerez, à coup sûr !
...
Il est un fait que je suis encore immatérielle puisque pas encore une cellule. Je suis donc censée n’être rien… ou pas encore quelque chose ! Cependant, j’ai l’impression de faire exception à la règle, car je suis déjà dotée de la pensée !<br>
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/jannickWeber/couverture-recto-jamba-pour-internet-min.webp" class="img-fluid" alt="Couverture du livre CISAILLER DU ROCHER">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 9782363440259</p>
