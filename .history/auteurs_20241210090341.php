...
<div class="d-none d-md-block">
  <!-- Groupe 1 -->
  <div class="book-group mb-5" id="desktop-book-group-1">
    <div class="book-card">
      <a href="link_to_book_A.html">
        <img src="images/pierreBrandao/leCoeurAsesSaisons.png" class="img-fluid" alt="Livre A">
        <div class="book-card-content">
  ...
  <!-- Groupe 2 -->
  <div class="book-group d-none" id="desktop-book-group-2">
    <div class="book-card">
      <a href="link_to_book_F.html">
        <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre F">
        <div class="book-card-content">
  ...
  <div class="navigation-buttons">
    <button id="prev-group-button" class="btn btn-primary" disabled>Précédent</button>
    <button id="next-group-button" class="btn btn-primary">Suivant</button>
  </div>
</div>
