        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/pierreBrandao/ecartDeMemoire.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre Les ronds-points de la colère">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Arte et Poésie
                    </p>
                    <p class="lead">
                        ...
                        <img src="images/pierreBrandao/michel-bourriau-et-pierre-brandao.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre Les ronds-points de la colère">
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/pierreBrandao/L" class="img-fluid" alt="Couverture du livre L'enlèvement">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 220</p>
