...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateMobileButtons() {
        ...
        if (currentMobileGroup === mobileGroups.length - 1) {
            ...
            mobileNextBtn.classList.add('unclickable'); // Ajout de la classe
        } else {
            mobileNextBtn.disabled = false;
            mobileNextBtn.classList.remove('unclickable');
        }
    }
    ...
    function updateDesktopButtons() {
        ...
        if (currentDesktopGroup === desktopGroups.length - 1) {
            ...
            desktopNextBtn.classList.add('unclickable'); // Ajout de la classe
        } else {
            desktopNextBtn.disabled = false;
            desktopNextBtn.classList.remove('unclickable');
        }
    }
