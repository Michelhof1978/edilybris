...
<div class="mobile-only">
  <div id="mobile-group-1" class="mobile-card-container">
    <div class="mobile-card">
      <a href="link_to_book_A.html">
        ...
        <div class="mobile-card-content">
          <div class="mobile-card-author">Brandao Pierre</div>
          <div class="mobile-card-price">15,00 €</div>
        </div>
      </a>
    </div>
  </div>
  <div id="mobile-group-2" class="mobile-card-container mobile-hidden">
    <div class="mobile-card">
      <a href="link_to_book_B.html">
        ...
        <div class="mobile-card-content">
          <div class="mobile-card-author">Cathelineau Jocelyne</div>
          <div class="mobile-card-price">23,00 €</div>
        </div>
      </a>
    </div>
  </div>
  <div id="mobile-group-3" class="mobile-card-container mobile-hidden">
    <div class="mobile-card">
      <a href="link_to_book_C.html">
        ...
        <div class="mobile-card-content">
          <div class="mobile-card-author">Chauvin Lydia</div>
          <div class="mobile-card-price">12,00 €</div>
        </div>
      </a>
    </div>
  </div>
  <div id="mobile-group-10" class="mobile-card-container mobile-hidden">
    <div class="mobile-card">
      <a href="link_to_book_J.html">
        <img src="images/sample/sample10.webp" class="img-fluid" alt="Couverture de livre Book 10">
        <div class="mobile-card-content">
          <div class="mobile-card-author">Author 10</div>
          <div class="mobile-card-price">14,00 €</div>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="mobile-navigation">
    <button id="mobile-back-button" class="mobile-button xl-button text-white" disabled>Précédent</button>
    <button id="mobile-next-group-button" class="mobile-button xl-button text-white">Suivant</button>
  </div>
</div>
