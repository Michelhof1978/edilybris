...
// Nombre total de citations (calculé dynamiquement)
...
<section class="citations text-white py-4">
    <div class="container">
        ...
        <div class="pagination d-flex justify-content-center mt-4">
            <!-- Bouton Précédent -->
            <a href="?page=<?php echo max(1, $pageActuelle - 1); ?>" class="btn btn-light me-2 <?php echo $pageActuelle == 1 ? 'disabled' : ''; ?>">Précédent</a>

            <!-- Numéros de page -->
            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                <a href="?page=<?php echo $i; ?>" class="btn <?php echo $i == $pageActuelle ? 'btn-primary' : 'btn-light'; ?> mx-1"><?php echo $i; ?></a>
            <?php endfor; ?>

            <!-- Bouton Suivant -->
            <a href="?page=<?php echo min($totalPages, $pageActuelle + 1); ?>" class="btn btn-light ms-2 <?php echo $pageActuelle == $totalPages ? 'disabled' : ''; ?>">Suivant</a>
        </div>
    </div>
</section>
</main>
