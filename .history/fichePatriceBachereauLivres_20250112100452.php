            ...
            <div class="bio-content">
                <div class="bio-text">
                    <p class="lead text-white text-center m-4">
                        ...
                        <a href="https://christophekro.wixsite.com/art-bordeaux" target="_blank" rel="noopener noreferrer">https://christophekro.wixsite.com/art-bordeaux</a>
                    </p>
                </div>
                    ...
                    <div id="mobile-group1PierreBrandao" class="mobile-books-container">
                        <div class="mobile-book-card">
                            <a href="fichePatriceBachereau.php">
                                <img src="images/patriceBachereau/image-basse-resolution-couverture-min.webp" class="img-fluid" alt="Couverture de L'amuserie">
                                <div class="mobile-book-details">
                                    <div class="mobile-book-author">P</div>
                    ...
                    <div id="desktop-group1PierreBrandao" class="new-card-container">
                        ...
                        <div class="new-card">
                            <a href="fichePierreBrandaoLamuserie.php">
                                <img src="images/pierreBrandao/XLlamuserie.webp" class="img-fluid" alt="Couverture de L'amuserie">
