...
<div class="d-block d-md-none">
    ...
    <!-- Groupe 27 DAVIDE BEAULIEU -->
    <div id="mobile-group2" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/davidBeaulieu/couv-le-sillage-de-l-encre-1.webp" class="img-fluid" alt="Couverture de livre Sur le ventre irisé de nos rivières">
                <div class="mobile-book-details">
