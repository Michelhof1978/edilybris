...
<!--  card XL-->
<script>
  // Fonction pour basculer entre les groupes de livres
let currentGroup = 1;
const totalGroups = 2;
...
function showGroup(group) {
    ...
    for (let i = 1; i <= totalGroups; i++) {
        const groupElement = document.getElementById(`new-group${i}`);
        if (i === group) {
            groupElement.classList.remove('new-hidden');
        } else {
            groupElement.classList.add('new-hidden');
        }
    }
