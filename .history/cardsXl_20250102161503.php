...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group14" class="mobile-books-container mobile-hidden">
     ...
     <div id="mobile-group17" class="mobile-books-container mobile-hidden">
      ...
      <div id="mobile-group18" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_J.html">
                <img src="images/lucLeGuennec/couvrectodeuzellge-br-pour-site (1)-min.png" class="img-fluid" alt="Couverture de livre Retour à l'essentiel">
                <div class="mobile-book-details">
    ...
    <div id="desktop-group5" class="new-card-container new-hidden">
        ...
        <div class="new-card">
         ...
         <div class="new-card">
            <a href="link_to_book_J.html">
                <img src="images/lucLeGuennec/couvrectodeuzellge-br-pour-site (1)-min.png" class="img-fluid" alt="Couverture de livre Meeurtre à la micro cart">
                <div class="new-card-content">
