...
<!-- MODE DESKTOP -->
<!-- Groupe 1 (Visible uniquement sur Desktop) -->
...
<!-- Groupe 2 (Visible uniquement sur Desktop) -->
<div class="L-card-container mb-5 d-none d-md-block" id="L-group2">
    <div class="L-card">
        <a href="link_to_book_F.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre F">
            <div class="L-card-content">
...
<!-- Boutons de navigation (Visible uniquement sur Desktop) -->
<div class="L-navigation d-none d-md-block">
    <button id="L-backButton" class="L-button text-white" disabled>Précédent</button>
    <button id="L-nextGroupButton" class="L-button text-white">Suivant</button>
</div>
