...
<div class="d-block d-md-none">
    ...
    <div id="mobile-group1PierreBrandao" class="mobile-books-container">
        <div class="mobile-book-card">
            <a href="ficheLucLeGuennecdeuzeLLGe.php">
                <img src="images/lucLeGuennec/lucLeGuennec.webp" class="img-fluid" alt="Couverture de livre deuzeLLGe">
    ...
    <div id="desktop-group1PierreBrandao" class="new-card-container">
        ...
        <div class="new-card">
            <a href="ficheLucLeGuennecdeuzeLLGe.php">
                <img src="images/lucLeGuennec/lucLeGuennec.webp" class="img-fluid" alt="Couverture de livre  mes Mots Sont Des Paysages">
