...
<div class="headerAuteur">
    <div class="containerAuteur">
        <h1>Jean-Pierre Crétel</h1>
        <img src="images/jeanPierreCretel/jeanPierreCretel.webp" alt="Portrait de Jean-Pierre Crétel" class="img-fluid bio-image">
    </div>
</div>
            ...
            <div class="bio-content">
                <div class="bio-text text-center">
                    ...
                    <blockquote class="text-white">
                        <p>Le cri du goéland<br>
                            Raye la plage ce matin<br>
                            À travers les nuages<br>
                            Et les remous marins.<br>
                            <em>(extrait de Partant de toi)</em>
                        </p>
                    </blockquote>

                    <img src="images/jeanPierreCretel/toulouse-1_11zon.webp" class="img-fluid w-25 rounded mb-3 d-block mx-auto" alt="Paysage de Toulouse">
                    ...
                    <blockquote class="text-white">
                        <p>Enfance, ma belle enfance<br>
                            ...
                            <em>(extrait de Paris, années 50)</em>
                        </p>
                    </blockquote>

                    <img src="images/jeanPierreCretel/reims_11zon_11zon.webp" class="img-fluid w-25 rounded mb-3 d-block mx-auto" alt="Vue de Reims">
                </div>
            </div>
        </div>
    </section>
...
<div class="d-block d-md-none">
    <!-- Groupes de livres -->
    <div class="mobile-books-container" aria-label="Liste de livres de Pierre Brandao">
        <div class="mobile-book-card">
            <a href="fichePierreBrandaoLamuserie.php">
                <img src="images/pierreBrandao/XLlamuserie.webp" class="img-fluid" alt="Couverture du livre L'amuserie">
    ...
    <div id="mobile-group11PierreBrandao" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
    ...
    <div id="desktop-group2PierreBrandao" class="new-card-container new-hidden">
        ...
        <div class="new-card">
         ...
         <!-- carte 10 LES RONDS POINTS DE LA COLERE-->
         <div class="new-card">
            <a href="fichePierreBrandaoRondsPointsDeLaColere.php">
                <img src="images/pierreBrandao/img010 (1)-min.webp" class="img-fluid" alt="Couverture de livre LES RONDS POINTS DE LA COLERE">
                <div class="new-card-content">
