...
<?php include("promotions.php"); ?>
 ...
 <script>
   const lGroup1 = document.getElementById('xl-group1');
    const lGroup2 = document.getElementById('xl-group2');
    const lBackButton = document.getElementById('xl-backButton');
    const lNextGroupButton = document.getElementById('xl-nextGroupButton');
