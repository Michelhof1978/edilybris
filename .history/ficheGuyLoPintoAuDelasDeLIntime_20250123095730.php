...
<div class="text-center mt-3">
   ...
   <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/carousel4.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/carousel5.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/carousel6.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/carousel7.webp" alt="Peinture artistique">
        </div>
        <div class="carousel-item">
            <img class="d-block w-75 mx-auto" src="images/veroniqueAsh/carousel8.webp" alt="Peinture artistique">
        </div>
    </div>
