...
<!-- CARDS POUR MOBILE -->
<div id="new-group1" class="new-card-container mobile-layout">
  <div class="new-card">
    <a href="link_to_book_A.html">
      <img src="images/pierreBrandao/XLlamourafleurdame.png" class="img-fluid mobile-img" alt="Livre A">
  ...
  <div class="new-card">
    <a href="link_to_book_B.html">
      <img src="images/pierreBrandao/XLlamuserie.png" class="img-fluid mobile-img" alt="Livre B">
      <div class="new-card-content">
...
<!-- Groupe 2 -->
<div id="new-group2" class="new-card-container mobile-layout new-hidden">
  <div class="new-card">
    <a href="link_to_book_F.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" class="img-fluid mobile-img" alt="Livre F">
      <div class="new-card-content">
...
<div class="new-navigation">
  <button id="new-backButton" class="new-button mobile-button text-white" disabled>Précédent</button>
  <button id="new-nextGroupButton" class="new-button mobile-button text-white">Suivant</button>
</div>



 <!-- CARDS XL DESKTOP-->
<div id="new-group1" class="new-card-container d-none d-md-block">
  <div class="new-card">
    <a href="link_to_book_A.html">
