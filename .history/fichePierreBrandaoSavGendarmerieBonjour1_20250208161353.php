        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/pierreBrandao/savGendarmerieBonjour1.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">22,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">SAV gendarmerie bonjour 1</h3>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2022
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 92
                    </p>
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Anectoctes
                    </p>
                    <p>
                        <strong class="h2Jaune">Référence :</strong> 9782363440525
                    </p>
                    <p class="lead">
                    <p>
...
<!-------------------------------------------------------------------------------------->
                    ...
                    <h3 class="h2Jaune text-center m-3">ALERTE AUX TOILETTES</h3>
                    <div class="col-12 text-center">
...
<h3 class="h2Jaune text-center m-3">BRÈVE CHARENTE-MARITIME</h3>
                    <div class="col-12 text-center">
...
<h3 class="h2Jaune text-center m-3">BOB & LA CHANSON DE PRÉVERT</h3>
                    <div class="col-12 text-center">
...
<h3 class="h2Jaune text-center m-3">GONFLÉ, MAIS PAS QU’UN PNEU..</h3>
                    <div class="col-12 text-center">
                    <img src="images/pierreBrandao/corg.webp" class="img-fluid w-75 mb-3" alt="ILLUSTATION">
                </div>
                <p>
    6 novembre 2016 à 5 h 27, CORG 17<br>

    — Gendarmerie, bonjour.<br>
    Une voix d’homme répond :<br>
    — Bonjour, je voudrais savoir où se trouvent vos contrôles routiers...<br>
    — Puis-je en connaître la raison, Monsieur ?<br>
    — En fait, je dois absolument rejoindre Blaye, mais j’ai un peu bu...<br>
    — Ah ! D’accord. Quelles sont la marque et l’immatriculation de votre véhicule ?<br>
    — J’ai une BMW, mais je ne suis pas assez con pour vous donner son numéro...<br>
    — Peut-être, Monsieur, mais vous osez quand même nous contacter pour éviter les contrôles alcoolémie. Vous comprendrez que votre question n’est pas pertinente.<br>
    — Bien sûr que si, qu’elle est pertinente ! Vous devez me dire où ils sont.<br>
    — Non, monsieur.<br>
    — C’est quoi, votre matricule ?<br>
    — Pourquoi, Monsieur ?<br>
    — Si je perds mon permis, je vous en tiendrai personnellement pour responsable !<br>
</p>

<!-------------------------------------------------------------------------------------->

<h3 class="h2Jaune text-center m-3">ARRRRGH... HIC AU VERT</h3>
                    <div class="col-12 text-center">
                    <img src="images/pierreBrandao/portrait-pierre-dessin-seul.webp" class="img-fluid w-75 mb-3" alt="ILLUSTATION">
                </div>
                    <p>
                    7 juillet 2022, BTA Saint-Maixent-l’École
...
<h3 class="h2Jaune text-center m-3">LE VER DE TROP</h3>
                    <div class="col-12 text-center">
                    <img src="images/pierreBrandao/portrait-pierre-dessin-seul.webp" class="img-fluid w-75 mb-3" alt="ILLUSTATION">
                </div>
                    <p>
                    2 septembre 2022, au CORG 79
            ...
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/pierreBrandao/savGendarmerieBonjour1.webp" class="img-fluid" alt="Couverture du livre SAV GENDARMERIE BONJOUR 2 ">
                    ...
                    <div class="livre-details">
                        <h3 class="h2Jaune">Sav gendarmerie bonjour 1</h3>
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 92</p>
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 9782363440525</p>

                        <p class="lead">
    <strong class="h2Jaune">Résumé :</strong> 

    Certaines administrations sont confrontées, au quotidien, à des situations burlesques - comme l’Éducation Nationale et ses candidats au bac à l’imagination fertile. La gendarmerie n’échappe pas à la règle. Ce sont ses « perles » que vous proposent Pierre Brandao, en poste douze ans au centre opérationnel de la gendarmerie (le fameux 17) et Gendy La Fontaine, l’énigmatique Community Manager de la Gendarmerie des Deux-Sèvres. À eux deux, ils ont concocté un recueil basé sur la surprise souvent, la bêtise parfois, la drôlerie toujours.

    Qui est Bob ? Un peu de nous tous en somme, mais il est surtout le prétexte à rire, à se dérider dans un monde enclin à la morosité, à s’échapper de son quotidien tristounet envahi par les affres de la pandémie et la sourde menace d’un conflit qui n’en finit pas... 

    Alors, riez, partagez, faites-vous plaisir ! Et n’oubliez pas qu’un jour, ce Bob pourrait vous ressembler !
</p>

                        <a href="images/bulletin-de-commande-2024.pdf" class="lien text-white fw-bold" download>Télécharger le bon de commande</a>
                        <h3 class="h2Jaune mt-5 text-center">Extraits</h3>
<!-------------------------------------------------------------------------------------->
                        <h4 class="h2Jaune mt-2 mb-3 text-center">ALERTE AUX TOILETTES</h4>
                        <div class="col-12 text-center">
                </div>
                <p>
    5 septembre 2022, COB Parthenay

    Hier, en fin de journée, un individu au comportement suspect est signalé dans les toilettes d’un établissement médical. Selon le témoin, il pourrait s’agir d’un trafic de stupéfiants. Les gendarmes sont aussitôt engagés. Sur place, ils progressent avec infiniment de précautions vers le lieu du délit puis, soudainement, investissent la pièce. Là, les militaires tombent nez à nez avec la personne signalée.

    Les pieds dans l’eau, cet homme travesti en femme cherche désespérément à remplir une poche pour mieux rembourrer son soutien-gorge. Il a surtout réussi à inonder les toilettes !

    Comme il n’y a rien d’illégal à ce trafic, l’individu a été invité à pratiquer ses hobbies à son domicile !

    Au final, une histoire stupéfiante qui ne l’est pas tant au regard des circonstances, mais que l’on a plaisir à vous conter.
</p>
...
<h4 class="h2Jaune mt-2 mb-3 text-center">BRÈVE CHARENTE-MARITIME</h4>
    ...
    Une dame sollicite le central d’urgence, car sa bouteille de gaz est vide. Elle n’arrive pas à joindre son mari qui se trouve chez la voisine, laquelle est aussi sa maîtresse... Raison pour laquelle il ne lui répond pas au téléphone.

    La requérante souhaite que le gendarme contacte l’époux volage afin qu’il vienne changer sa bouteille de gaz !
    (Nota : on a eu chaud, elle aurait pu le demander au gendarme...)
</p>
                    
                      
<!-------------------------------------------------------------------------------------->

<h4 class="h2Jaune mt-2 mb-3 text-center">BOB & LA CHANSON DE PRÉVERT</h4>
                        <div class="col-12 text-center">
                </div>
                <p>
