...
<div class="mobile-view d-block d-sm-none ">
    ...
    <div class="navigation">
        <button id="mobile-back-button" class="button xl-button back-button text-white" disabled>Précédent</button>
        <button id="mobile-next-button" class="button xl-button next-button text-white">Suivant</button>
    </div>
</div>
