                ...
                <div class="row mb-4">
                    ...
                    <div class="form-check mb-4 mt-3">
                        ...
                        <label class="form-check-label text-white" for="rgpdCheckbox">
                            J'accepte que mes données personnelles soient traitées conformément à <a href="politiquedeConfidentialite.php"><span class="fw-bold">Politique De Confidentialité</span></a>.
                        </label>
                        <div class="invalid-feedback">
