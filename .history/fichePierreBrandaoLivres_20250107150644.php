        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                ...
                <div class="col-12 text-white">
                    ...
                    <p class="lead">
                    <strong class="h2Jaune">Genre :</strong> PolicierCe septième recueil de poésies de Pierre Brandao regroupe des textes dont le fil conducteur est la musique des mots, la mélodie des émotions...
                    </p>
