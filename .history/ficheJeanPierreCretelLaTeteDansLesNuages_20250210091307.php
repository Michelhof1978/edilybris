...
<section class="livres-mobile d-block d-md-none py-4">
    <div class="container">
        ...
        <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
            ...
            <div class="col-12 text-white">
                ...
                <p>
                    <strong class="h2Jaune">Nombre de pages :</strong> 70<br><br>
    ...
    Avec ce troisième recueil, Jean-Pierre Crétel reprend la valise du rêve et nous convie pour un nouveau voyage.<br>
    Cette plongée nous entraîne dans sa très heureuse enfance jusqu'à notre époque quelque peu bousculée.<br>
...
<blockquote class="text-center coloryellow">
    « Empreintes de pieds<br>
    Sur la plage promènent<br>
    Un défilé de vagues »
</blockquote>
