        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/jeanMichelDelaneau/Couv-Recto-Nouvelles-d-ici.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre                 <div class="col-12 text-white">
">
                ...
                <div class="col-12 text-white">
                    ...
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 132<br><br>
                        <strong class="h2Jaune">Référence :</strong> 9782363440648
                    </p>
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Nouvelles
                    </p>

                    <p class="lead">
                        <strong class="h2Jaune">Résumé :</strong>Tout d’abord, prendre des nouvelles de la vie, des humains, de tant d’existences.
...
Lorsque le fond et la forme se rejoignent...
                    ...
                    <h4 class="h2Jaune text-center m-3 coloryellow">L’enfer du décord</h4>

                    <p>  

                  <p class="coloryellow"><strong >Avertissement : cet épisode – fictif – de la Guerre du Vietnam (1963-1975) se base néanmoins sur des faits réels, similaires ou approchants...</strong> </p> <strong >
...
Mais dès la vingtième année de Tao, la guerre à nouveau ravageait sa patrie, tel un mal inéluctable ! Depuis 1963, lui qui était le poète et l’intellectuel du village, en était devenu l’écrivain public, puis en 1965 l’instituteur et secrétaire de la Maison commune.<br><br>
...
<p class="coloryellow text-center">« Dieu qui, du haut des nuages,
...
Surgissant du grand barrage ! »   
    ...
    <section class="livres d-none d-md-block">
        <div class="containerAuteur">
            ...
            <!-- Carte 1 Nouvelles d'ici et nulle part-->
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/jeanMichelDelaneau/Couv-Recto-Nouvelles-d-ici.webp" class="img-fluid" alt="Couverture du livre CISAILLER DU ROCHER">
                    ...
                    <div class="livre-details">
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Genre :</strong> Nouvelles</p>
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 132</p><br><br>
