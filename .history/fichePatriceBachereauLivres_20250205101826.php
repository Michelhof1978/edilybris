            ...
            <div class="bio-content">
                <div class="bio-text">
                    <p class="lead text-white text-center ">
                        ...
                        L'auteur a pourtant ses journées bien remplies : entre son activité professionnelle, ses occupations de maire de sa commune, et sa vie familiale, il n'a de cesse de rêver et faire partager son onirisme en embrassant le papier de ses écrits fantastiques.<br> La grande prophétie s'annonce comme les prémices d'une aventure de haut vol, car la suite est déjà attendue !
