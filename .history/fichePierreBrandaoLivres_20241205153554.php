...
Attention : ce recueil n'est plus disponible en version papier, uniquement en numérique.</p>
    ...
    <div class="livre-content">
        <div class="livre-image">
            ...
            <p class="prix fw-bold coloryellow mt-3 fs-4 lead">15,00 €</p>
        </div>
        <div class="livre-details">
            ...
            <div class="colonnes">
                <div class="colonne">
                    <h4>Résumé</h4>
                    <p>Cet ouvrage a été publié en 2001, par les éditions Cléa à Dijon. Une cinquantaine de textes a fait l'objet d'une interprétation musicale à l'occasion d'un spectacle donné à Surgères, par Music Art Diffusion (association présidée par Christian Méchin, directeur de l'école de musique de Surgères).</p>
                </div>
                <div class="colonne">
