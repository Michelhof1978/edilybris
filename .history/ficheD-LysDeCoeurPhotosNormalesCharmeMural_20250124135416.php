...
<main>
        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/d-LysDeCoeur/" class="img-fluid w-75 mb-3" alt="Couverture du livre luminescence">
                    <p class="fw-bold coloryellow fs-5">29,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Photos normales/charme mural  </h3>
                    <p>
                    </p>
                    <p>
    ...
    <section class="livres d-none d-md-block">
        <div class="containerAuteur">
            <h2>Photos normales/charme mural </h2>
            <!-- Carte 1 photos normales/charme mural  -->
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    ...
                    <div class="livre-details ">
                        <h3 class="h2Jaune">Photos normales/charme mural  </h3>
                        <p class="annee text-white"><strong class="h2Jaune">Genre :</strong> Calendrier</p>
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 978-2-36344-0-891  </p>
