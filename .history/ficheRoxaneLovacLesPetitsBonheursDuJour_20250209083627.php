...
<main>
    ...
    <section class="livres-mobile d-block d-md-none py-4">
        <div class="container">
            ...
            <!-- Livre 1 : Les petits bonheurs du jour-->
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/roxaneLovac/1-pbdj-validee_11zon.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">14,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Les petits bonheurs du jour</h3>
                    <p>
                    ...
                    <p>
                        <strong class="h2Jaune">Référence  :</strong> 9782363440716
                    </p>
                    <p class="lead">
    Empathique et sensible, Marie est une enfant souvent submergée par ses émotions.<br> 
    Les années s’écoulent, la petite fille grandit avec ses failles, et pense avoir trouvé le chemin du bonheur.<br> 
    Mais, à mi-parcours, l’univers la met à l’épreuve : ses fondations s’écroulent.<br> 
    Une seule solution s’impose : comprendre l’impact de son passé sur son présent, afin de mieux se reconstruire !<br><br> 

    Qui ne s’est jamais retourné, se demandant comment il en était arrivé là ?<br><br> 

    Se lancer dans la lecture de ce roman, c’est prendre Marie par la main et cheminer avec elle, de son tout premier souvenir à ceux de la quarantenaire épanouie qu’elle est devenue.<br> 
    C’est aussi accepter son invitation à lâcher prise, à s’aimer tel que l’on est et à aimer la vie.<br><br> 

    Les petits bonheurs du jour, une histoire vraie, une rencontre en toute intimité…<br><br> 

    « Un roman qui fait du bien.<br> 
    Ces 200 pages sont des pelotes d’authenticité et de partage, les unes cousues avec les autres, jusqu’à obtenir une belle armure cotonneuse, douce et confortable.<br> 
    Un témoignage d’une immense richesse. »<br> Mensuel VIDICI<br><br> 

    « Loin d’être banale, cette histoire vraie devient passionnante sous la plume de Roxane Lovac.<br> 
    Portant sur un sujet très actuel, ce livre se lit d’un trait, un pur plaisir. »<br> Hebdomadaire LE LITTORAL<br><br> 

    « C’est une belle leçon de bienveillance et de recherche de soi »<br> MÉDIS MAGAZINE<br><br> 

    De la même autrice : Ma vie parfaitement imparfaite<br> 
</p>
    ...
    <section class="livres d-none d-md-block">
        <div class="containerAuteur">
            ...
            <!-- Carte 1 : Les petits bonheurs du jour -->
