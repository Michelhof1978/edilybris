    ...
    <div class="">
        <div class="navbar-brand">
            <div class="container-fluid">
                <!-- Logo et titre -->
                <a class="navbar-brand ms-2 d-flex align-items-center" href="index.php">
    <img src="chemin/vers/votre/logo.png" alt="Logo Edi'lybris" class="logo" style="height: 120px; width: auto;">
    <strong class="text-white nav-brand-logo ms-3">
