            ...
            <div class="text-center">
                ...
                <div>
                    <img src="images/JosyaneDeJesus/houari-au-centre-intermondes-la-rochelle_11zon.webp" 
                         ...
                         class="img-fluid w-25m-5 rounded">
                </div>
            </div>
        </div>
    ...
    <div id="mobile-group1PierreBrandao" class="mobile-books-container">
        <div class="mobile-book-card">
            <a href="ficheJocelynCathelineauLeGrandLivre.php">
                <img src="images/JocelyneCathelineau/couvlegrandlivre-jc.webp" 
                     alt="Couverture du livre Le Grand Livre par Jocelyne Cathelineau" 
                     class="img-fluid">
    ...
    <div id="mobile-group2PierreBrandao" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="ficheJocelynCathelineauLesMysteresDeLhometrou.php">
                <img src="images/JocelyneCathelineau/couv-recto-mystere-hometrou.webp" 
                     alt="Couverture du livre Les Mystères de Lhometrou par Jocelyne Cathelineau" 
                     class="img-fluid">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Jocelyne Cathelineau</div>
...
<div class="d-none d-md-block">
    ...
    <!-- <div class="desktop-navigation">
        <button id="desktop-back-btnPierreBrandao" class="desktop-button" disabled>Précédent</button>
        <button id="desktop-next-btnPierreBrandao" class="desktop-button">Suivant</button>
    </div> -->
</div>
