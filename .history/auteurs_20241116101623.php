...
<a href="page-details-4.html" class="card-link">
 ...
 <div class="container-wrapper">
  <!-- Flèche gauche -->
  <button class="scroll-btn left" onclick="scrollContainer('left')">&#8592;</button>
  ...
  <div class="container">
    ...
    <!-- carte 5 -->
    <a href="page-details-5.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
    ...
    <!-- carte 6 -->
    <a href="page-details-6.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
    ...
    <!-- carte 7 -->
    <a href="page-details-7.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
    ...
    <!-- carte 8 -->
    <a href="page-details-8.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
    ...
    <!-- carte 9 -->
    <a href="page-details-9.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
    ...
    <!-- carte 10 -->
    <a href="page-details-10.html" class="card-link">
      <div class="card">
        <img src="images/pierreBrandao/luciolesMagiques.png" alt="">
        <div class="card-info">
          <h2 class="text-white">LUCIOLES MAGIQUES</h2>
  ...
  <!-- Flèche droite -->
  <button class="scroll-btn right" onclick="scrollContainer('right')">&#8594;</button>
</div>
