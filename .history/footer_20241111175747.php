...
<div class="footer-cta pt-5 pb-5">
    <div class="row text-center d-flex justify-content-around">
        <div class="col-lg-3 col-md-4 mb-30">
            <div class="single-cta d-flex align-items-center">
                <i class="fas fa-map-marker-alt me-4"></i> <!-- Augmenté à `me-4` pour plus d'espace -->
                <div class="cta-text">
                    <h4>Adresse</h4>
                    <span>La Motte<br>58 300 Decize</span>
                </div>
        ...
        <div class="col-lg-3 col-md-4 mb-30">
            <div class="single-cta d-flex align-items-center">
                <i class="fas fa-phone me-4"></i> <!-- Augmenté à `me-4` pour plus d'espace -->
                <div class="cta-text">
                    <h4>Appelez-Nous !</h4>
        ...
        <div class="col-lg-3 col-md-4 mb-30">
            <div class="single-cta d-flex align-items-center">
                <i class="far fa-envelope-open me-4"></i> <!-- Augmenté à `me-4` pour plus d'espace -->
                <div class="cta-text">
                    <h4>Mail</h4>
                    <span>michelhoff1978@gmail.com</span>
                </div>
    ...
    <img src="images/logoHarmonyDigital.png" alt="Logo Harmony Digital" class="img-fluid w-25" style="margin-bottom: -10px;">
</a>
                    <div class="copyright-text">
                        <p>
