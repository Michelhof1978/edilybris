...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (isMobile) {
        ...
        function updateGroupVisibility() {
            ...
            backButton.disabled = currentGroupIndex === 1;  // Le bouton Précédent est désactivé sur la première carte
            nextButton.disabled = currentGroupIndex === groups.length - 2;  // Le bouton Suivant est désactivé sur la dernière carte
        }
