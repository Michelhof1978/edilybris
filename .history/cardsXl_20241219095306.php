...
<div class="d-block d-md-none mb-3"> 
  ...
  <div id="new-group2" class="new-card-container new-hidden">
    <div class="new-card">
      <a href="link_to_book_F.html">
        <img src="images/jeanPierreCretel/parfois-les-vagues-couv.webp" class="img-fluid" alt="Couverture de livre luminescence">
        <div class="new-card-content">
          <div class="new-card-author"> Cretel Jean-Pierre</div>
          <div class="new-card-price">13,00 €</div>
        </div>
...
<div id="new-group2" class="new-card-container new-hidden">
  ...
  <div class="new-card">
    <a href="link_to_book_F.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" class="img-fluid" alt="Couverture de livre luminescence">
      <div class="new-card-content">
