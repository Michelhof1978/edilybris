...
<section class="home m-5">
    ...
    <div class="users-color-container">
        ...
        <img class="img-fluid item imgAuteurIndex" src="images/annieBrunetot/annieBrunetot.webp" style="--i: 2" alt="Photo écrivain">
        <span class="item" style="--i: 3"></span>
        <img class="img-fluid item imgAuteurIndex" src="images/pierreBrandao/pierreBrandao.webp" style="--i: 4" alt="Photo écrivain">
        <img class="img-fluid item imgAuteurIndex" src="images/gillesHerve/gillesHerve.webp" style="--i: 10" alt="Photo écrivain">
