...
<div id="l-group2" class="l-card-container l-hidden">
  <div class="l-card">
    ...
    </a>iv class="l-card-description">Une intrigue captivante entre réel et imaginaire.</div>
        <div class="l-card-price">16,99 €</div>
      </div>
    </a>
  </div>
...
<div id="l-group3" class="l-card-container l-hidden">
  <div class="l-card">
    <a href="link_to_book_K.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" alt="Livre K">
      <div class="l-card-content">
        <div class="l-card-title">Les flammes de l'aube</div>
        <div class="l-card-author">Lucie Charrier</div>
        <div class="l-card-description">Un récit épique sur le courage et l'héroïsme.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_L.html">
      <img src="images/pierreBrandao/XLlamourafleurdame.png" alt="Livre L">
      <div class="l-card-content">
        <div class="l-card-title">Sous la lumière des étoiles</div>
        <div class="l-card-author">Élodie Marceau</div>
        <div class="l-card-description">Un roman émouvant sur la perte et la rédemption.</div>
        <div class="l-card-price">17,49 €</div>
      </div>
    </a>
  </div>
  <div class="l-card">
    <a href="link_to_book_M.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" alt="Livre M">
      <div class="l-card-content">
        <div class="l-card-title">Les larmes de la mer</div>
        <div class="l-card-author">Maxime Léger</div>
        <div class="l-card-description">Une aventure maritime pleine de mystères.</div>
        <div class="l-card-price">14,50 €</div>
      </div>
    </a>
  </div>
  <div class="l-card">
    <a href="link_to_book_N.html">
      <img src="images/pierreBrandao/XLlamuserie.png" alt="Livre N">
      <div class="l-card-content">
        <div class="l-card-title">L'appel des ancêtres</div>
        <div class="l-card-author">Nicolas Guérin</div>
        <div class="l-card-description">Un voyage ancestral à la recherche de ses racines.</div>
        <div class="l-card-price">16,20 €</div>
      </div>
    </a>
  </div>
  <div class="l-card">
    <a href="link_to_book_O.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" alt="Livre O">
      <div class="l-card-content">
        <div class="l-card-title">Les horizons perdus</div>
        <div class="l-card-author">Olivia Dufresne</div>
        <div class="l-card-description">Un drame humain avec des thèmes d'espoir et de réconciliation.</div>
        <div class="l-card-price">18,90 €</div>
      </div>
    </a>
  </div>
</div>
