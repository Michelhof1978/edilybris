...
<section id="citations-section" class="citations text-white py-4">
    ...
    <!-- Bouton Précédent -->
    <a href="?page=<?php echo max(1, $pageActuelle - 1); ?>#citations-section" class="prev" data-page="<?php echo max(1, $pageActuelle - 1); ?>">Précédent</a>

    <!-- Numéros de page -->
    <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
        <a href="?page=<?php echo $i; ?>#citations-section" class="page-num <?php echo $i == $pageActuelle ? 'active' : ''; ?>" data-page="<?php echo $i; ?>"><?php echo $i; ?></a>
    <?php endfor; ?>

    <!-- Bouton Suivant -->
    <a href="?page=<?php echo min($totalPages, $pageActuelle + 1); ?>#citations-section" class="next" data-page="<?php echo min($totalPages, $pageActuelle + 1); ?>">Suivant</a>
</div>
