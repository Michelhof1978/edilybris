...
<?php
// Nombre de citations par page (2 par ligne)
$citationsParLigne = 2;
...
$citations = [
    ...
    // Ajoutez ici les autres citations
];

// Nombre total de citations
$totalCitations = count($citations);

// Récupérer la page actuelle depuis l'URL, ou définir 1 par défaut
...
// Extraire les citations pour la page actuelle
