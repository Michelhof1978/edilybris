...
<div class="d-block d-md-none">
    ...
    <!-- Groupe 2 L'enlèvement-->
    <div id="mobile-group2" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_B.html">
                <img src="images/pierreBrandao/couvlenlevement.webp" class="img-fluid" alt="Couverture de livre Les mystères de l'Hometrou">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">Br</div>
