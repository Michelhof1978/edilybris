...
<!--  CARDS XL-->
<script>
 const groups = document.querySelectorAll('.new-card-container'); // Sélectionne tous les groupes
...
function updateGroups() {
  groups.forEach((group, index) => {
    group.classList.toggle('new-hidden', index !== currentGroup);
  });

  // Désactiver les boutons si on est au début ou à la fin
  newBackButton.disabled = currentGroup === 0;
  newNextGroupButton.disabled = currentGroup === groups.length - 1;
}
