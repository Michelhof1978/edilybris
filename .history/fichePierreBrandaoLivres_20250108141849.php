...
<div class="d-block d-md-none">
    ...
    <!-- Groupe 1 L'enlèvement-->
    <div id="mobile-group2" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_B.html">
                <img src="images/pierreBrandao/couvlenlevement.webp" class="img-fluid" alt="Couverture de livre Les mystères de l'enlèvement">
    ...
    <div id="mobile-group3" class="mobile-books-container mobile-hidden">
        <div class="mobile-book-card">
            <a href="link_to_book_C.html">
                <img src="images/lydiaChauvin/couv-recto-recette-pour-un-spectacle.webp" class="img-fluid" alt="Couverture de livre SAV GENDARMERIE BONJOUR 2">
                <div class="mobile-book-details">
                    <div class="mobile-book-author">bRANDAO</div>
