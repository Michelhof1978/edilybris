...
<section class="citations text-white py-4">
    <div class="container">
        ...
        <div class="row">
            <!-- Vérification si des citations sont disponibles pour cette page -->
            <?php if (!empty($citationsPage)) : ?>
                <?php foreach ($citationsPage as $titre => $citation) : ?>
                    <div class="col-md-6 mb-4">
                        <h3 class="h2Jaune"><?php echo htmlspecialchars($titre); ?></h3>
                        <blockquote>
                            <p><?php echo nl2br(htmlspecialchars($citation)); ?></p>
                        </blockquote>
                    </div>
                <?php endforeach; ?>
            <?php else : ?>
                <p>Aucune citation disponible pour cette page.</p>
            <?php endif; ?>
        </div>
        ...
        <div class="pagination text-center">
            ...
            <?php if ($pageActuelle > 1) : ?>
                <a href="?page=<?php echo $pageActuelle - 1; ?>" class="prev btn btn-outline-light mx-1">Précédent</a>
            <?php endif; ?>

            <!-- Numéros de pages -->
            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                <a href="?page=<?php echo $i; ?>" class="page-num btn btn-outline-light mx-1 <?php echo $i == $pageActuelle ? 'active' : ''; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>
            ...
            <?php if ($pageActuelle < $totalPages) : ?>
                <a href="?page=<?php echo $pageActuelle + 1; ?>" class="next btn btn-outline-light mx-1">Suivant</a>
            <?php endif; ?>
        </div>
    </div>
</section>
