...
// Définir le nombre de citations à afficher par page
$citationsParLigne = 2;

// Nombre total de citations (vous pouvez obtenir ce nombre en comptant les éléments de votre tableau $citations)
$totalCitations = count($citations);

// Calculer le nombre total de pages
$totalPages = ceil($totalCitations / $citationsParLigne);

// Récupérer la page actuelle depuis l'URL, avec une valeur par défaut de 1
$pageActuelle = isset($_GET['page']) ? (int)$_GET['page'] : 1;

// Calculer l'index de début des citations pour la page actuelle
...
<main class="content">
    ...
    <section class="citations text-white py-4">
        <div class="container">
            ...
            <!-- Affichage des citations de la page actuelle -->
            <div class="row">
            ...
            <div class="pagination text-center">
                <?php if ($pageActuelle > 1): ?>
                    <a href="?page=<?php echo $pageActuelle - 1; ?>" class="btn btn-secondary">Précédent</a>
                <?php endif; ?>

                <span class="page-info">Page <?php echo $pageActuelle; ?> sur <?php echo $totalPages; ?></span>

                <?php if ($pageActuelle < $totalPages): ?>
                    <a href="?page=<?php echo $pageActuelle + 1; ?>" class="btn btn-secondary">Suivant</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
