...
<div class="L-card-container mb-5" id="L-group1">
    ...
    <div class="L-card">
        <a href="link_to_book_B.html">
            <img src="images/pierreBrandao/luciolesMagiques.png" alt="Livre B">
            <div class="L-card-content">
    ...
    <div class="L-card">
        <a href="link_to_book_C.html">
            <img src="images/pierreBrandao/leCoeurAsesSaisons.png" alt="Livre C">
            <div class="L-card-content">
...
<div class="L-card-container L-hidden" id="L-group3">
    ...
    <div class="L-card">
        <a href="link_to_book_L.html">
            <img src="images/pierreBrandao/leCoeurAsesSaisons.png" alt="Livre L">
            <div class="L-card-content">
...
<div class="carousel-container">
        <div class="carousel">
            <div class="carousel-item">
                <img src="https://via.placeholder.com/600x400?text=Personne+1" alt="Personne 1">
                <div class="name-overlay">Nom Personne 1</div>
            </div>
            <div class="carousel-item">
                <img src="https://via.placeholder.com/600x400?text=Personne+2" alt="Personne 2">
                <div class="name-overlay">Nom Personne 2</div>
            </div>
            <div class="carousel-item">
                <img src="https://via.placeholder.com/600x400?text=Personne+3" alt="Personne 3">
                <div class="name-overlay">Nom Personne 3</div>
            </div>
        </div>
    </div>
