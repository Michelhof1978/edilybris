...
<div id="new-group1" class="new-card-container">
  ...
  <div class="new-card">
    <a href="link_to_book_B.html">
      <img src="images/JocelyneCathelineau/couv-recto-mystere-hometrou.webp" class="img-fluid" alt="Couverture de livre ">
      <div class="new-card-content">
        <div class="new-card-author">CathelineauJocelyne</div>
