...
<div class="d-block d-md-none">
    ...
    <div class="mobile-navigation">
        <button id="mobile-back-btn-pierre-brandao" class="mobile-button" disabled>Précédent</button>
        <button id="mobile-next-btn-pierre-brandao" class="mobile-button">Suivant</button>
    </div>
</div>
