<div class="headerAuteur">
    <div class="containerAuteur">
        ...
        <img src="images/abdelFrançoisNadini/abdelFrançoisNadini.webp" alt="Portrait de Abdel Francois Nadini" class="img-fluid bio-image">
    </div>
</div>
...
Mon but est de laisser un témoignage.
<img src="images/abdelFrançoisNadini/photo1.jpg" alt="Portrait de Abdel Francois Nadini" class="img-fluid rounded w-50"><br>

Je l’ai souhaité pour deux raisons. La première concerne ma fille Yasmine, elle en sait déjà beaucoup sur moi... mais je voulais qu'elle en sache davantage.
...
Devant vous, petit ou grand...
            ...
            <div class="d-block d-md-none">
                <!-- Groupe 1 - Abdel Francois Nadini - De la bougie aux projecteurs-->
                <div id="mobile-group1PierreBrandao" class="mobile-books-container">
                    <div class="mobile-book-card">
                        <a href="ficheAbdelFrancoisNadiniDeLaBougieAuxProjecteur.php">
                            <img src="images/abdelFrançoisNadini/dlball-recto-seul-br (1)_11zon.webp" class="img-fluid" alt="Couverture de  Le sillage de l'encre">
            ...
            <div class="d-none d-md-block">
                <div id="desktop-group1PierreBrandao" class="new-card-container">
                    <!-- Carte 1 - Abdel Francois Nadini - De la bougie aux projecteurs-->
                    <div class="new-card">
                        <a href="ficheAbdelFrancoisNadiniDeLaBougieAuxProjecteur.php">
                            <img src="images/abdelFrançoisNadini/dlball-recto-seul-br (1)_11zon.webp" class="img-fluid" alt="Couverture de  Le sillage de l'encre">
