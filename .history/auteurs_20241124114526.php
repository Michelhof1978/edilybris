 ...
 <div id="l-group1" class="l-card-container">
  ...
  <div class="l-card">
    <a href="link_to_book_2.html">
      ...
      <div class="xl-card-content">
        <div class="l-card-title">Titre du Livre 2</div>
        <div class="l-card-author">Auteur 2</div>
        <div class="l-card-description">Description du livre 2.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_3.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" alt="Livre 3">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 3</div>
        <div class="l-card-author">Auteur 3</div>
        <div class="l-card-description">Description du livre 3.</div>
        <div class="l-card-price">9,99 €</div>
      </div>
    </a>
  </div>
  <div class="l-card">
    <a href="link_to_book_4.html">
      <img src="images/pierreBrandao/XLlamourafleurdame.png" alt="Livre 4">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 4</div>
        <div class="l-card-author">Auteur 4</div>
        <div class="l-card-description">Description du livre 4.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_5.html">
      <img src="images/pierreBrandao/XLlamuserie.png" alt="Livre 5">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 5</div>
        <div class="l-card-author">Auteur 5</div>
        <div class="l-card-description">Description du livre 5.</div>
...
<!-- Groupe 2 -->
<div id="l-group2" class="l-card-container xl-hidden">
  <div class="xl-card">
    <a href="link_to_book_6.html">
      <img src="images/pierreBrandao/XLquesavonsnousdumonde.png" alt="Livre 6">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 6</div>
        <div class="l-card-author">Auteur 6</div>
        <div class="l-card-description">Description du livre 6.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_7.html">
      <img src="images/pierreBrandao/XLlamourafleurdame.png" alt="Livre 7">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 7</div>
        <div class="l-card-author">Auteur 7</div>
        <div class="l-card-description">Description du livre 7.</div>
        <div class="l-card-price">11,99 €</div>
      </div>
    </a>
  </div>
  <div class="l-card">
    <a href="link_to_book_8.html">
      <img src="images/pierreBrandao/XLlamuserie.png" alt="Livre 8">
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 8</div>
        <div class="l-card-author">Auteur 8</div>
        <div class="l-card-description">Description du livre 8.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_9.html">
      ...
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 9</div>
        <div class="l-card-author">Auteur 9</div>
        <div class="l-card-description">Description du livre 9.</div>
  ...
  <div class="l-card">
    <a href="link_to_book_10.html">
      ...
      <div class="l-card-content">
        <div class="l-card-title">Titre du Livre 10</div>
        <div class="x-card-author">Auteur 10</div>
        <div class="l-card-description">Description du livre 10.</div>
  ...
  <button id="l-backButton" class="xl-button" disabled>Précédent</button>
  <button id="l-nextGroupButton" class="xl-button">Suivant</button>
</div>
...
<?php include("promotions.php"); ?>
 ...
 <script>
  let currentGroupIndex = 0; // Index du groupe actuellement visible
  const bookGroups = document.querySelectorAll('.book-group'); // Tous les groupes

  function showGroup(direction) {
    // Masquer le groupe actuel
    bookGroups[currentGroupIndex].classList.add('hidden');

    // Calculer l'index du nouveau groupe
    if (direction === 'next') {
      currentGroupIndex = (currentGroupIndex + 1) % bookGroups.length;
    } else if (direction === 'prev') {
      currentGroupIndex = (currentGroupIndex - 1 + bookGroups.length) % bookGroups.length;
    }

    // Afficher le nouveau groupe
    bookGroups[currentGroupIndex].classList.remove('hidden');
  }

  // Initialisation : afficher uniquement le premier groupe
