...
<div class="carousel-container d-none d-md-block">
 ...
 <!-- BRUNETOT ANNIE-->
      <a href="ficheAnnieBrunetot.php" class="profile-card director">
       ...
       <!-- LOVAC ROXANE-->
      <a href="ficheRoxaneLovac" class="profile-card producer">
        <div class="imgBx">
          <img src="images/abdelFrançoisNadini/abdelFrançoisNadini.png" class="img-fluid" alt="Photo de LOVAC ROXANE">
        </div>
        <div class="details mb-3">
          <h2>LOVAC ROXANE</h2>
        </div>
