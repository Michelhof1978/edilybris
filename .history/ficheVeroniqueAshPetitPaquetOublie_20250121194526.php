...
<div class="text-center mt-3">
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div id="customCarousel" class="my-carousel slide" data-bs-ride="carousel">
  ...
  <div class="my-carousel-inner">
    <div class="my-carousel-item active">
      <img class="my-carousel-img d-block w-100" src="images/veroniqueAsh/caroussel1.webp" alt="Photo ancienne de Véronique Ash">
    </div>
    <div class="my-carousel-item">
      <img class="my-carousel-img d-block w-100" src="images/veroniqueAsh/caroussel2.webp" alt="Véronique Ash">
    </div>
    <div class="my-carousel-item">
      <img class="my-carousel-img d-block w-100" src="images/veroniqueAsh/caroussel3.webp" alt="Véronique Ash">
    </div>
  </div>
  <button class="my-carousel-control-prev" type="button" data-bs-target="#customCarousel" data-bs-slide="prev">
    <span class="my-carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="my-carousel-control-next" type="button" data-bs-target="#customCarousel" data-bs-slide="next">
