<?php include("head.php"); ?>
 ...
 <div class="book-carousel-container container vh-100 d-flex justify-content-center align-items-center">
    ...
    <div class="carousel-navigation mt-3">
        <button class="prev btn btn-primary" onclick="showGroup('prev')">Précédent</button>
        <button class="next btn btn-primary" onclick="showGroup('next')">Suivant</button>
    </div>
</div>
