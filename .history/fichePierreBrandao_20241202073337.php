    ...
    <div class="container">
        ...
        <div class="pagination">
            <?php if ($pageActuelle > 1) : ?>
                <a href="?page=<?php echo $pageActuelle - 1; ?>" class="prev">Précédent</a>
            <?php endif; ?>

            <span>Page <?php echo $pageActuelle; ?> sur <?php echo $totalPages; ?></span>

            <?php if ($pageActuelle < $totalPages) : ?>
                <a href="?page=<?php echo $pageActuelle + 1; ?>" class="next">Suivant</a>
            <?php endif; ?>
        </div>
    </div>
</section>
