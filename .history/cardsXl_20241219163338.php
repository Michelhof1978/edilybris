...
<div class="d-block d-md-none mb-3">
        ...
        <div id="new-group6" class="new-card-container new-hidden">
         ...
         <div id="new-group6" class="new-card-container new-hidden">
            <div class="new-card">
                <a href="link_to_book_F.html">
                    <img src="images/jeanPierreCretel/couv-recto-ltdln-copie.webp" class="img-fluid" alt="Couverture de livre Entre vie et poesie">
                    <div class="new-card-content">
    ...
    <div id="desktop-group2" class="new-card-container new-hidden">
        ...
        <div class="new-card">
            <a href="link_to_book_H.html">
                <img src="images/emmanuelTrouve/couverture-recto-entre-vie-et-poe-sie.webp" class="img-fluid" alt="Couverture de livre Entre vie et poesie">
                <div class="new-card-content">
                    <div class="new-card-author">Trouvé Emmanuel</div>
                    <div class="new-card-price">17,00 €</div>
                </div>
