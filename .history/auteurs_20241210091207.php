...
<div class="d-none d-md-block">
    <!-- Groupe 1 -->
    <div class="L-card-container mb-5" id="desktop-book-group-1">
        <div class="L-card">
            <a href="link_to_book_A.html">
                <img src="images/pierreBrandao/leCoeurAsesSaisons.png" class="img-fluid" alt="Livre A">
    ...
    <!-- Groupe 2 -->
    <div class="L-card-container L-hidden" id="desktop-book-group-2">
        <div class="L-card">
            <a href="link_to_book_F.html">
                <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre F">
                <div class="L-card-content">
    ...
    <!-- Groupe 3 -->
    <div class="L-card-container L-hidden" id="desktop-book-group-3">
        <div class="L-card">
            <a href="link_to_book_J.html">
                <img src="images/pierreBrandao/leCoeurAsesSaisons.png" class="img-fluid" alt="Livre J">
                <div class="L-card-content">
                    <div class="L-card-title">Les étoiles du matin</div>
                    <div class="L-card-author">Julien Lefevre</div>
                    <div class="L-card-description">Un voyage poétique au fil des saisons.</div>
                    <div class="L-card-price">16,99 €</div>
                </div>
            </a>
        </div>
        <div class="L-card">
            <a href="link_to_book_K.html">
                <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre K">
                <div class="L-card-content">
                    <div class="L-card-title">Les mystères de l'infini</div>
                    <div class="L-card-author">Catherine Renaud</div>
                    <div class="L-card-description">Une aventure inoubliable dans l'inconnu.</div>
        ...
        <div class="L-card">
            <a href="link_to_book_L.html">
                <img src="images/pierreBrandao/luciolesMagiques.png" class="img-fluid" alt="Livre L">
                <div class="L-card-content">
                    <div class="L-card-title">Les chemins de l'âme</div>
                    <div class="L-card-author">Michel Bernard</div>
                    <div class="L-card-description">Un roman philosophique à la recherche de soi.</div>
    ...
    <div class="L-navigation">
        <button id="desktop-prev-group-button" class="L-button text-white" disabled>Précédent</button>
        <button id="desktop-next-group-button" class="L-button text-white">Suivant</button>
    </div>
</div>
