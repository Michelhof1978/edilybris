...
<div id="mobile-book-carousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <!-- Ajoutez d'autres cartes de livres ici comme dans l'exemple précédent -->
    </div>
...
<div class="d-none d-md-block">
    ...
    <div class="L-card-container mb-5" id="L-group1">
        ...
        <!-- Ajoutez d'autres cartes de livres ici pour le groupe 1 -->
    </div>
    ...
    <div class="L-card-container d-none" id="L-group2">
        ...
        <!-- Ajoutez d'autres cartes de livres ici pour le groupe 2 -->
    </div>
