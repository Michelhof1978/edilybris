...
<div class="text-center mt-3">
       ...
       <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                ...
                <div class="col-12 text-white">
                    ...
                    <p class="lead">
                    <strong class="h2Jaune">Résumé :</strong> une hincipet d’honnêteté. Mais lorsque l’un des plus hauts ténors de l’institution l’invite à accepter une mission particulièrement sensible, elle est loin de s’imaginer dans quel monde elle allait plonger. Et quand s’ajoute à ce challenge une affaire d’enlèvement qui la touchera en plein coeur, ses convictions s’opposeront au principe même qui régit toute personne sur Terre : l’Amour ! De Charente-Maritime en Bretagne, suivez cette héroïne et tentez de percer l’obscurantisme qui confronte toujours les éléments du bien à ceux du mal !
                    </p>
                    <div class="text-center mt-3">
                        <a href="images/bulletin-de-commande-2024.pdf" class="btn btn-warning fw-bold text-white" download>Télécharger le bon de commande</a>
                    </div>                    
...
<div id="livre-1" class="livre">
    <div class="livre-content">
        ...
        <div class="livre-details ">
            ...
            <p class="lead text-white"><strong class="h2Jaune">Résumé :</strong> Après Meurtres à la micro-carte, la gendarme Isabelle Loubry doit beaucoup prendre sur elle pour accepter de pardonner au genre humain. Cependant, elle aussi doit rendre des comptes auprès d’une hiérarchie fidèle à ses principes de transparence et d’honnêteté.
...
<div class="text-center">
  <h4><strong class="h2Jaune mb-5">ANGRY BOB - 2</strong></h4> 
        <img class="img-fluid w-50 mb-1 mt-4" src="images/pierreBrandao/angry-bob-2.webp" alt="Image centrée">
    </div>

<p class="text-white m-5">Dimanche 6 février 2022, vers 17 heures à Saint-Maixent-l’École, un automobiliste est contrôlé en état d’ébriété au volant de son véhicule.
