...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateGroupVisibility(groups, currentGroupIndex, backButton, nextButton) {
    ...
    // Gestionnaire de clic pour les boutons "Suivant" et "Précédent"
    function handleButtonClick(event, groups, currentGroupIndex, backButton, nextButton) {
        if (event.target.id === "new-backButton" && currentGroupIndex > 0) {
            currentGroupIndex--;
        } else if (event.target.id === "new-nextGroupButton" && currentGroupIndex < groups.length - 1) {
            currentGroupIndex++;
        }
        updateGroupVisibility(groups, currentGroupIndex, backButton, nextButton);
    }
    ...
    if (isMobile) {
        ...
        nextButton.addEventListener("click", (event) => handleButtonClick(event, groups, currentGroupIndex, backButton, nextButton));
        backButton.addEventListener("click", (event) => handleButtonClick(event, groups, currentGroupIndex, backButton, nextButton));
    ...
    // Desktop
        ...
        const nextButton = document.getElementById("L-nextGroupButton2");
        const backButton = document.getElementById("L-backButton2");
        const groups = Array.from(document.querySelectorAll(".L-card-container"));
        let currentGroupIndex = 0;
