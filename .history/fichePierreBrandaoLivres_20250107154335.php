...
Alors, continuez de rire, partager, faites-vous plaisir ! Évitez simplement qu’un jour, ce Bob, ce soit vous !</p>
    ...
    <p class="lead text-white"> <span><strong class="h2Jaune">RIDE LIKE THE WINE</strong></span> n’a pas attendu la retraite pour se consacrer à la photographie. Sa thématique préférée depuis de nombreuses années : la féminité. 
