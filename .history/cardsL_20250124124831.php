...
<div class="d-block d-md-none"> 
  ...
  <!-- Groupe 3 WEBER DENECHAUD JANNICK-->
...
<div id="new-group12" class="new-card-container new-hidden">
    <div class="new-card">
      <a href="ficheD-LysDeCoeur-photos-normales-charme-chevalet.php">
        <img src="images/d-LysDeCoeur/calendrier-normal-chevaletjanvier_11zon.webp" class="img-fluid" alt="Couverture de livre Loozana blues">
        <div class="new-card-content">
...
<div id="new-group12" class="new-card-container new-hidden">
    <div class="new-card">
      <a href="ficheD-LysDeCoeur-photos-fantasy-chevalet.php">
        <img src="images/d-LysDeCoeur/calendrier-fantasy-chevalet-janvier_11zon.webp" class="img-fluid" alt="Couverture de livre Loozana blues">
        <div class="new-card-content">
          <div class="new-card-author">D-LYS Decoeur</div>
          <div class="new-card-price">20,00 €</div>
        </div>
...
<div class="d-none d-md-block">
    ...
    <div class="L-card-container mb-5" id="L-group1">
        ...
        <!-- Carte 3 Jannick Weber Denechaud -->
        <div class="L-card">
    ...
    <div class="L-card-container L-hidden" id="L-group2">
        ...
        <div class="L-card">
            <a href="fichePierreBrandaoMiroirDeMesSaisons.php">
                <img src="images/pierreBrandao/luciolesMagiques.webp" class="img-fluid" alt="couverture de livre Lucioles Magiques">
                <div class="L-card-content">
    ...
    <div class="L-card-container L-hidden" id="L-group3">
        ...
        <div class="L-card">
            <a href="ficheDLysDecoeurPhotosNormalesChevalet.php">
                <img src="images/d-LysDeCoeur/calendrier-normal-chevaletjanvier_11zon.webp" class="img-fluid" alt="calendrier Photos Normales Chevalet">
                <div class="L-card-content">
        ...
        <!-- Carte 9 D-LYS Decoeur -->
        <div class="L-card">
            <a href="ficheDLysDecoeurPhotosFantasyChevalet.php">
                <img src="images/d-LysDeCoeur/calendrier-fantasy-chevalet-janvier_11zon.webp" class="img-fluid" alt="calendrier Photos Fantasy Chevalet">
                <div class="L-card-content">
                    <div class="L-card-author">D-LYS Decoeur</div>
                    <div class="L-card-price">20,00 €</div>
                </div>
