        ...
        <div class="container">
            ...
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                ...
                <div class="col-12 text-white">
                    ...
                    <p class="lead">
    <strong class="h2Jaune">Résumé :</strong> Chez cet artiste, le cliché n'est pas figé et dépasse la barrière de la simple beauté physique : le modèle est repensé, réinventé et le résultat s'adresse à notre moi profond. C'est là qu'intervient Arlette.<br><br>

    Par son verbe, elle tente une approche intelligente et profonde du mystère de son ami Michel, et cela permet au lecteur d'entrouvrir l'espace secret qui gouverne sa parole de créateur.<br><br>
