...
<style>
    ...
    @media (max-width: 767px) {
        .vh-100 {
            height: 100vh !important; /* Assure que la vidéo occupe toute la hauteur */
        }
        .position-relative {
            height: auto; /* Désactive la hauteur fixe du conteneur */
        }
        .w-100 {
            width: 100%; /* Remplit tout l'espace horizontal */
        }
        .video {
            object-fit: contain; /* Permet à la vidéo de s'ajuster sans être coupée */
        }
    }
</style>
