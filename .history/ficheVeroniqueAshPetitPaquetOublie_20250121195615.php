...
<div class="text-center mt-3">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel1.webp" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel2.webp" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel3.webp" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel4.webp" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel5.webp" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="images/veroniqueAsh/caroussel.webp" alt="Third slide">
    </div>
  </div>
