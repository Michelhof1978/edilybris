...
<div class="new-navigation">
  <button id="new-backButton" class="new-button xl-button text-" disabled>Précédent</button>
  <button id="new-nextGroupButton" class="new-button xl-button">Suivant</button>
</div>
