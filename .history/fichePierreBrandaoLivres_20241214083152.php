...
<!-- MODE MOBILE--> 
<section class="livres text-center d-block d-md-none">
    <div class="containerAuteur">
        <h2>Les livres de Pierre Brandao</h2>

       <!-- Carte 1 --> 
<div id="livre-1" class="">
    <div class="livre-content">
        ...
        <div class="livre-details ">
            ...
            <p class="lead text-white text-center"><strong class="h2Jaune">Résumé :</strong> Ce septième recueil de poésies de Pierre Brandao regroupe des textes dont le fil conducteur est la musique des mots, la mélodie des émotions, l’inspiration du coeur.
