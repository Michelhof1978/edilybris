...
<div class="carousel-item">
 ...
 <div class="carousel-item">
        ...
        <!-- HORNEC VERONIQUE -->
 <div class="carousel-item">
            <a href="ficheVeroniqueHornec.php">
                <div class="person">
                    <img src="images/gillesHerve/gillesHerve.webp" alt="Photo de HORNEC VERONIQUE" class="photo">
                    <p class="name">HORNEC VERONIQUE </p>
                </div>
            </a>
        </div>
...
<div class="carousel-container d-none d-md-block">
 ...
 <!-- DAVID BEAULIEU-->
      <a href="ficheVeroniqueHornec.php" class="profile-card director">
        <div class="imgBx">
          <img src="images/veroniqueHornec/" class="img-fluid" alt="Gilles Hervé">
        </div>
        <div class="details mb-3">
          <h2>Gilles Hervé</h2>
        </div>
