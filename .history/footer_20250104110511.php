...
document.addEventListener("DOMContentLoaded", function() {
  // Mobile
  let currentGroup = 1;
  const totalGroups = 4; // Adjusted to 4 for your 4 groups
  ...
  const showGroup = (groupNumber) => {
    ...
    const current = document.getElementById(`L-group${groupNumber}`);
...
document.addEventListener("DOMContentLoaded", function() {
  // Desktop
  let currentDesktopGroup = 1;
  const totalDesktopGroups = 4; // Adjusted to 4 for your 4 groups
