...
<title>Gilles Hervé</title>
<meta name="description" content="Biographie et livres de Gilles Hervé. Découvrez ses œuvres et téléchargez un bon de commande.">
</head> 
...
<main>
    ...
    <section class="livres-mobile d-block d-md-none py-4">
        <div class="container">
            <h2 class="text-center text-white">Le livre de Gilles Hervé</h2>

            <!-- Livre 1 : Pourquoi écrivez-vous ? -->
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/gillesHerve/couv-pourquoi-ecrit-on-gilles-herve.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre luminescence">
                    <p class="fw-bold coloryellow fs-5">8,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Pourquoi écrivez-vous ?</h3>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2024
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 48<br> <br>
                        <strong class="h2Jaune">Référence :</strong> 9782363440839
                    </p>
                    <p>
...
Elle est au gré du vent...
    ...
    <section class="livres d-none d-md-block">
        <div class="containerAuteur">
            <h2>Pourquoi écrivez-vous ?</h2>
            <!-- Carte 1 Pourquoi écrivez-vous ?-->
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/francoisGalard/couvrectoluminescence.webp" class="img-fluid" alt="Couverture du livre luminescence">
                    ...
                    <div class="livre-details">
                        <h3 class="h2Jaune">Pourquoi écrivez-vous ?</h3>
                        ...
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong>9782363440839</p>
