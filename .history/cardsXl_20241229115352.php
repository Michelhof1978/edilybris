<!-- CARDS XL Mobile -->
 <!-- Conteneur pour mobile -->
    <div class="d-block d-md-none mb-3">
        ...
        <!-- Ajoutez d'autres groupes ici, avec des IDs uniques -->
    </div>

    <!-- Boutons de navigation -->
    <div class="new-navigation text-center">
        <button id="new-mobile-backButton" class="btn btn-primary" disabled>Précédent</button>
        <button id="new-mobile-nextGroupButton" class="btn btn-primary">Suivant</button>
    </div>
