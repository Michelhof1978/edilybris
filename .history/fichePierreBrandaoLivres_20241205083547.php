        ...
        <div class="bio-content">
            ...
            <div class="bio-text">
                ...
                <div class="text-center">
                    <a href="fichePierreBrandaoCitations.php" class="btn" style="background-color: yellow; color: black; border: 1px solid #ccc; font-size: 1.5rem; padding: 15px 30px; border-radius: 8px;">Découvrir les citations</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="livre-3" class="livre livre-hidden">
            ...
            <p class=" fw-bold coloryellow mt-3 fs-4 lead">15,00 €</p>
                ...
                <div class="livre-details">
                    ...
                    <p class="lead text-white"><strong class="h2Jaune">Résumé :</strong> Résumé du livre 3...</p>
                    <a href="images/bulletin-de-commande-2024.pdf" class="lien text-white fw-bold" download>Télécharger le bon de commande</a>
                </div>
            </div>
        </div>
        ...
        <div id="livre-5" class="livre livre-hidden">
            ...
            <p class=" fw-bold coloryellow mt-3 fs-4 lead">15,00 €</p>
                ...
                <div class="livre-details">
                    ...
                    <p class="lead text-white"><strong class="h2Jaune">Résumé :</strong> Résumé du livre 5...</p>
                    <a href="images/bulletin-de-commande-2024.pdf" class="lien text-white fw-bold" download>Télécharger le bon de commande</a>
                </div>
            </div>
        </div>
