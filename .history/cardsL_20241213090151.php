...
<div id="book-carousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
  ...
  <div class="new-navigation">
    <button class="carousel-control-prev new-button xl-button text-white" type="button" data-bs-target="#book-carousel" data-bs-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">Précédent</span>
    </button>
    <button class="carousel-control-next new-button xl-button text-white" type="button" data-bs-target="#book-carousel" data-bs-slide="next">
