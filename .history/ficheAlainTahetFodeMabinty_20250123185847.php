...
<main>
    ...
    <section class="livres-mobile d-block d-md-none py-4">
        <div class="container">
            ...
            <!-- Livre 1 : Fodé Mabinty Camara, vivre ou survivre -->
            <div id="livre-1-mobile" class="livre-mobile row align-items-center my-4">
                <div class="col-12 text-center">
                    <img src="images/alainTahet/vireOuSurvivre.webp" class="img-fluid w-75 mb-3" alt="Couverture du livre L'enlèvement">
                    <p class="fw-bold coloryellow fs-5">15,00 €</p>
                </div>
                <div class="col-12 text-white">
                    <h3 class="h2Jaune text-center">Fodé Mabinty Camara, vivre ou survivre</h3>
                    <p>
                        <strong class="h2Jaune">Année de publication :</strong> 2023
                    </p>
                    <p>
                        <strong class="h2Jaune">Nombre de pages :</strong> 124<br><br>
                        <strong class="h2Jaune">Référence :</strong> 9782363440594
                    </p>
                    <p>
                        <strong class="h2Jaune">Genre :</strong> Récit
                    </p>

                    <p class="lead">
                        <strong class="h2Jaune">Résumé :</strong>Les réfugiés font désormais partie de notre quotidien. Nous les croisons toute la journée. Ils nous servent au restaurant, construisent nos maisons, nos immeubles, livrent les repas. Les images de ceux qui périssent en mer méditerranée avant d’avoir pu tenter leur chance sont devenues banales.
...
Voici son histoire.
                    ...
                    <img src="images/alainTahet/" class="img-fluid w-75 mb-3 d-block mx-auto" alt="Illustration">
...
Sœur Maria Assunta vient de croiser le chemin de Fodé Mabinty Camara.</P>
    ...
    <section class="livres d-none d-md-block">
        <div class="containerAuteur">
            ...
            <!-- Carte 1 Fodé Mabinty Camara, vivre ou survivre-->
            <div id="livre-1" class="livre">
                <div class="livre-content">
                    <div class="livre-image">
                        <img src="images/alainTahet/vireOuSurvivre.webp" class="img-fluid" alt="Couverture du livre Elle comme liberte">
                    ...
                    <div class="livre-details">
                        <h3 class="h2Jaune">Fodé Mabinty Camara, vivre ou survivre</h3>
                        <p class="annee text-white"><strong class="h2Jaune">Année de publication :</strong> 2023</p>
                        <p class="annee text-white"><strong class="h2Jaune">Genre :</strong> Récit</p>
                        <p class="annee text-white"><strong class="h2Jaune">Nombre de pages :</strong> 124</p>
                        <p class="annee text-white"><strong class="h2Jaune">Référence :</strong> 9782363440204</p>

                        <p class="lead text-white">
                        Les réfugiés font désormais partie de notre quotidien. Nous les croisons toute la journée. Ils nous servent au restaurant, construisent nos maisons, nos immeubles, livrent les repas. Les images de ceux qui périssent en mer méditerranée avant d’avoir pu tenter leur chance sont devenues banales.
